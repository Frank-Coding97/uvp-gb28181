...
-- 通道坐标来源标记（2026-09-21）：回答"这对坐标是谁写的"（catalog/mobile/manual）。
IF OBJECT_ID('gb_channel','U') IS NOT NULL AND COL_LENGTH('gb_channel','position_source') IS NULL ALTER TABLE gb_channel ADD position_source NVARCHAR(16) NOT NULL DEFAULT N'';
IF OBJECT_ID('gb_channel','U') IS NOT NULL AND COL_LENGTH('gb_channel','position_updated_at') IS NULL ALTER TABLE gb_channel ADD position_updated_at DATETIME2(3) NULL;
...
CREATE TABLE [gb_device] (
    ...
    [access_epoch] BIGINT NOT NULL CONSTRAINT [df_gb_device_access_epoch] DEFAULT 1,
    [legacy_revoked_before] DATETIME2(0) NULL,
    [cleanup_completed_epoch] BIGINT NOT NULL CONSTRAINT [df_gb_device_cleanup_completed_epoch] DEFAULT 1,
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'物理删除单条告警',N'/api/gb28181/alarms/:id',N'DELETE',N'告警管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/alarm-management' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/alarms/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除级联平台',N'/api/gb28181/cascade/platforms/:id',N'DELETE',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除通道收藏组',N'/api/gb28181/channel-favorite-groups/:id',N'DELETE',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/channel-favorite-groups/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'移除通道收藏',N'/api/gb28181/channel-favorite-groups/:id/channels',N'DELETE',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/channel-favorite-groups/:id/channels' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'取消云端录像下载',N'/api/gb28181/cloud-recordings/downloads/:taskId',N'DELETE',N'云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cloud-recordings/downloads/:taskId' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除单个云端录像',N'/api/gb28181/cloud-recordings/files/:id',N'DELETE',N'云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cloud-recordings/files/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除单个通道',N'/api/gb28181/device-mgmt/channel/:id',N'DELETE',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'停止回放会话',N'/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId',N'DELETE',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-record-playback/:channelId' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除预置位',N'/api/gb28181/device-mgmt/channel/:id/ptz/presets/:presetId',N'DELETE',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/presets/:presetId' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'停止对讲会话',N'/api/gb28181/device-mgmt/channel/:id/talk-sessions/:sessionId',N'DELETE',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/talk-sessions/:sessionId' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除自定义分组',N'/api/gb28181/device-mgmt/custom-groups/:id',N'DELETE',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/custom-groups/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除单个设备',N'/api/gb28181/device-mgmt/device/:id',N'DELETE',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'重置仪表盘布局',N'/api/gb28181/home/layout',N'DELETE',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/home/layout' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'强制停止当前直播/共享停播',N'/api/gb28181/play/:streamId',N'DELETE',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/play/:streamId' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除播放方案',N'/api/gb28181/playback-schemes/:id',N'DELETE',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/playback-schemes/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除录像计划',N'/api/gb28181/recording-plans/:id',N'DELETE',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除安全访问规则',N'/api/gb28181/security/access-rules/:id',N'DELETE',N'国标接入安全',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/security-preview' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/security/access-rules/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除媒体节点',N'/api/gb28181/zlm/nodes/:id',N'DELETE',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除 FFmpeg 源',N'/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key',N'DELETE',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除拉流代理',N'/api/gb28181/zlm/nodes/:id/proxies/pull/:key',N'DELETE',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/proxies/pull/:key' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除推流代理',N'/api/gb28181/zlm/nodes/:id/proxies/push/:key',N'DELETE',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/proxies/push/:key' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除插件示例',N'/api/plugins/example/delete',N'DELETE',N'插件示例',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/plugins/example' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/plugins/example/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'插件卸载',N'/api/pluginsmanager/uninstall',N'DELETE',N'插件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/pluginsmanager' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/pluginsmanager/uninstall' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'分片上传取消上传',N'/api/sysAffix/chunk/cancel',N'DELETE',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/chunk/cancel' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除文件',N'/api/sysAffix/delete',N'DELETE',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除API',N'/api/sysApi/delete',N'DELETE',N'接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/api' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysApi/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除部门',N'/api/sysDepartment/delete',N'DELETE',N'部门管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/division' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDepartment/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除字典',N'/api/sysDict/delete',N'DELETE',N'字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDict/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除字典项',N'/api/sysDictItem/delete',N'DELETE',N'字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDictItem/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除代码生成配置和字段信息',N'/api/sysGen/:id',N'DELETE',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysGen/:id' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'定时任务日志删除',N'/api/sysJobResults/delete',N'DELETE',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/joblog' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysJobResults/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'定时任务删除',N'/api/sysJobs/delete',N'DELETE',N'定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysJobs/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除登录日志',N'/api/sysLoginLog/delete',N'DELETE',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/login-log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysLoginLog/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'批量删除',N'/api/sysMenu/batchDelete',N'DELETE',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/batchDelete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除菜单',N'/api/sysMenu/delete',N'DELETE',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'日志删除',N'/api/sysOperationLog/delete',N'DELETE',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysOperationLog/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除参数',N'/api/sysParam/delete',N'DELETE',N'系统配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysparam' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysParam/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除角色',N'/api/sysRole/delete',N'DELETE',N'角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysRole/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'删除用户',N'/api/users/delete',N'DELETE',N'用户管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/account' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/users/delete' AND method=N'DELETE' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'预览',N'/api/codegen/preview',N'GET',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/codegen/preview' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'获取指定数据库中的表集合',N'/api/codegen/tables',N'GET',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/codegen/tables' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看级联平台列表',N'/api/gb28181/cascade/platforms',N'GET',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看级联平台',N'/api/gb28181/cascade/platforms/:id',N'GET',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看级联共享',N'/api/gb28181/cascade/platforms/:id/shares',N'GET',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms/:id/shares' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询通道收藏组',N'/api/gb28181/channel-favorite-groups',N'GET',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/channel-favorite-groups' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询云端录像下载',N'/api/gb28181/cloud-recordings/downloads/:taskId',N'GET',N'云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cloud-recordings/downloads/:taskId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询录像对账状态',N'/api/gb28181/cloud-recordings/reconciliations',N'GET',N'云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cloud-recordings/reconciliations' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询目录树',N'/api/gb28181/device-mgmt/catalog/tree',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/catalog/tree' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取目录节点详情',N'/api/gb28181/device-mgmt/catalog/tree/:id',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/catalog/tree/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取目录子节点',N'/api/gb28181/device-mgmt/catalog/tree/:id/children',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/catalog/tree/:id/children' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取通道详情',N'/api/gb28181/device-mgmt/channel/:id',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取设备控制能力',N'/api/gb28181/device-mgmt/channel/:id/control-capabilities',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/control-capabilities' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取通道运行状态',N'/api/gb28181/device-mgmt/channel/:id/device-status',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/device-status' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取通道挂载点',N'/api/gb28181/device-mgmt/channel/:id/mounts',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/mounts' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取回放会话',N'/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-record-playback/:channelId' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询巡航轨迹列表',N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise-tracks',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise-tracks' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取巡航轨迹详情',N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise-tracks/:trackId',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise-tracks/:trackId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询看守位',N'/api/gb28181/device-mgmt/channel/:id/ptz/home-position',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/home-position' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询云台操作结果',N'/api/gb28181/device-mgmt/channel/:id/ptz/operations/:operationId',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/operations/:operationId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询精准控制状态',N'/api/gb28181/device-mgmt/channel/:id/ptz/precise-status',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/precise-status' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询预置位列表',N'/api/gb28181/device-mgmt/channel/:id/ptz/presets',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/presets' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询录像查询条件',N'/api/gb28181/device-mgmt/channel/:id/record-query/options',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/record-query/options' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取抓拍会话',N'/api/gb28181/device-mgmt/channel/:id/snapshot-sessions/:sessionId',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/snapshot-sessions/:sessionId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取对讲会话',N'/api/gb28181/device-mgmt/channel/:id/talk-sessions/:sessionId',N'GET',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/talk-sessions/:sessionId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询通道时间轴',N'/api/gb28181/device-mgmt/channel/:id/timeline',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/timeline' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询通道列表',N'/api/gb28181/device-mgmt/channels',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channels' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取设备详情',N'/api/gb28181/device-mgmt/device/:id',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看设备升级',N'/api/gb28181/device-mgmt/device/:id/firmware-upgrades',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id/firmware-upgrades' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询设备维护操作',N'/api/gb28181/device-mgmt/device/:id/maintenance-operations',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id/maintenance-operations' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询设备状态事件',N'/api/gb28181/device-mgmt/device/:id/status-events',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id/status-events' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询设备订阅',N'/api/gb28181/device-mgmt/device/:id/subscriptions',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id/subscriptions' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询设备列表',N'/api/gb28181/device-mgmt/devices',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/devices' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询组织目录树',N'/api/gb28181/device-mgmt/directory/tree',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/directory/tree' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询地图聚合点',N'/api/gb28181/device-mgmt/map/clusters',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/map/clusters' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询地图标记点',N'/api/gb28181/device-mgmt/map/markers',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/map/markers' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询共享目标',N'/api/gb28181/device-mgmt/permission-workbench/grant-targets',N'GET',N'设备权限工作台',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-assignment' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/permission-workbench/grant-targets' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询统计覆盖率',N'/api/gb28181/device-traffic/coverage',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-traffic/coverage' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询实时流量',N'/api/gb28181/device-traffic/realtime',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-traffic/realtime' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询流量会话',N'/api/gb28181/device-traffic/sessions',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-traffic/sessions' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询流量汇总',N'/api/gb28181/device-traffic/summary',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-traffic/summary' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询流量趋势',N'/api/gb28181/device-traffic/trend',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-traffic/trend' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询当前观看',N'/api/gb28181/device-traffic/viewers',N'GET',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-traffic/viewers' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'下钻播放指标',N'/api/gb28181/home/drilldown/play',N'GET',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/home/drilldown/play' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'下钻 SIP 指标',N'/api/gb28181/home/drilldown/sip',N'GET',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/home/drilldown/sip' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'下钻流量指标',N'/api/gb28181/home/drilldown/traffic',N'GET',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/home/drilldown/traffic' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取仪表盘布局',N'/api/gb28181/home/layout',N'GET',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/home/layout' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取首页汇总',N'/api/gb28181/home/summary',N'GET',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/home/summary' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'播放流监控读取',N'/api/gb28181/play/:streamId/monitor',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/play/:streamId/monitor' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询播放方案',N'/api/gb28181/playback-schemes',N'GET',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/playback-schemes' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看播放方案',N'/api/gb28181/playback-schemes/:id',N'GET',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/playback-schemes/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看录像计划',N'/api/gb28181/recording-plans/:id',N'GET',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'搜索分配通道',N'/api/gb28181/recording-plans/:id/assignment-options/channels',N'GET',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/:id/assignment-options/channels' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'搜索分配设备',N'/api/gb28181/recording-plans/:id/assignment-options/devices',N'GET',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/:id/assignment-options/devices' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'SIP Trace 报文详情',N'/api/gb28181/sip-traces/messages/:id',N'GET',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip-traces' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip-traces/messages/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'SIP Trace 会话报文',N'/api/gb28181/sip-traces/sessions/:callId/messages',N'GET',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip-traces' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip-traces/sessions/:callId/messages' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取 SIP 平台信息',N'/api/gb28181/sip/platform',N'GET',N'SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/platform' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取全局通道音频配置',N'/api/gb28181/sip/service-config/default-channel-audio',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/default-channel-audio' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取默认播放协议',N'/api/gb28181/sip/service-config/default-playback-protocol',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/default-playback-protocol' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取固定地址播放配置',N'/api/gb28181/sip/service-config/fixed-address-playback',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/fixed-address-playback' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取全局订阅项目',N'/api/gb28181/sip/service-config/global-subscriptions',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/global-subscriptions' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取忽略通道离线异常通知配置',N'/api/gb28181/sip/service-config/ignore-channel-offline-status-notify',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/ignore-channel-offline-status-notify' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取收到心跳恢复设备上线配置',N'/api/gb28181/sip/service-config/online-on-heartbeat',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/online-on-heartbeat' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取播放鉴权配置',N'/api/gb28181/sip/service-config/play-auth',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/play-auth' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取预分配模式',N'/api/gb28181/sip/service-config/preallocation-mode',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/preallocation-mode' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取云台默认速度配置',N'/api/gb28181/sip/service-config/ptz-default-speed',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/ptz-default-speed' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取报警消息存储配置',N'/api/gb28181/sip/service-config/save-alarm-messages',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/save-alarm-messages' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取 SIP 命令超时时间',N'/api/gb28181/sip/service-config/sip-command-timeout',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/sip-command-timeout' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取 SIP 日志配置',N'/api/gb28181/sip/service-config/sip-log',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/sip-log' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取设备上线同步通道配置',N'/api/gb28181/sip/service-config/sync-channels-on-online',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/sync-channels-on-online' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取本机网络接口',N'/api/gb28181/sip/setup/network-interfaces',N'GET',N'SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/setup/network-interfaces' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取 SIP 配置状态',N'/api/gb28181/sip/setup/status',N'GET',N'SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/setup/status' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询探针检测结果',N'/api/gb28181/stream-probes/operations/:operationId',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/stream-probes/operations/:operationId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看媒体节点详情',N'/api/gb28181/zlm/nodes/:id',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询媒体服务重启状态',N'/api/gb28181/zlm/nodes/:id/restart',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/restart' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看媒体流详情',N'/api/gb28181/zlm/nodes/:id/streams/detail',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/detail' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'截取媒体流快照',N'/api/gb28181/zlm/nodes/:id/streams/snapshot',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/snapshot' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询媒体流观看者',N'/api/gb28181/zlm/nodes/:id/streams/viewers',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/viewers' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询单条数据',N'/api/plugins/example/:id',N'GET',N'插件示例',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/plugins/example' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/plugins/example/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'下载文件',N'/api/sysAffix/download/:id',N'GET',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/download/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'根据ID获取API信息',N'/api/sysApi/:id',N'GET',N'接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/api' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysApi/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'API列表',N'/api/sysApi/list',N'GET',N'接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysApi/list' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'获取部门列表',N'/api/sysDepartment/getDivision',N'GET',N'部门管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDepartment/getDivision' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'根据字典编码获取字典项列表',N'/api/sysDictItem/getByDictCode/:dictCode',N'GET',N'字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDictItem/getByDictCode/:dictCode' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'字典项管理',N'/api/sysDictItem/getByDictId/:dictId',N'GET',N'字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDictItem/getByDictId/:dictId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'获取代码生成配置详情',N'/api/sysGen/:id',N'GET',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysGen/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看定时任务日志',N'/api/sysJobResults/list',N'GET',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysJobResults/list' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'定时任务获取数据',N'/api/sysJobs/:id',N'GET',N'定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysJobs/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看登录日志详情',N'/api/sysLoginLog/:id',N'GET',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/login-log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysLoginLog/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'根据菜单ID获取API的ID集合',N'/api/sysMenu/apis/:id',N'GET',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/apis/:id' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'导出菜单',N'/api/sysMenu/export',N'GET',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/export' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'获取完整菜单列表',N'/api/sysMenu/getMenuList',N'GET',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/getMenuList' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'日志导出',N'/api/sysOperationLog/export',N'GET',N'日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysOperationLog/export' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'根据角色ID获取角色菜单权限',N'/api/sysRole/getUserPermission/:roleId',N'GET',N'角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysRole/getUserPermission/:roleId' AND method=N'GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'编辑通道参数',N'/api/gb28181/device-mgmt/channel/:id',N'PATCH',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'切换通道云端录制',N'/api/gb28181/device-mgmt/channel/:id/cloud-recording',N'PATCH',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/cloud-recording' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'云台归位点更新',N'/api/gb28181/device-mgmt/channel/:id/ptz/home-position',N'PATCH',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/home-position' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改通道传输模式',N'/api/gb28181/device-mgmt/channel/:id/stream-transport',N'PATCH',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/stream-transport' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改自定义分组',N'/api/gb28181/device-mgmt/custom-groups/:id',N'PATCH',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/custom-groups/:id' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新设备订阅',N'/api/gb28181/device-mgmt/device/:id/subscriptions/:kind',N'PATCH',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id/subscriptions/:kind' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'编辑设备',N'/api/gb28181/device/:deviceId',N'PATCH',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device/:deviceId' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'重命名播放方案',N'/api/gb28181/playback-schemes/:id',N'PATCH',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/playback-schemes/:id' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'启停录像计划',N'/api/gb28181/recording-plans/:id/status',N'PATCH',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/:id/status' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'切换通道录像模式',N'/api/gb28181/recording-plans/channels/:channelId/recording-mode',N'PATCH',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/channels/:channelId/recording-mode' AND method=N'PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'生成代码文件',N'/api/codegen/generate',N'POST',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/codegen/generate' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'批量物理删除告警',N'/api/gb28181/alarms/batch-delete',N'POST',N'告警管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/alarm-management' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/alarms/batch-delete' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'创建级联平台',N'/api/gb28181/cascade/platforms',N'POST',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'启用级联平台',N'/api/gb28181/cascade/platforms/:id/enable',N'POST',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms/:id/enable' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'创建回放会话',N'/api/gb28181/device-mgmt/channel/:id/playback-sessions',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-record-playback/:channelId' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/playback-sessions' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'控制回放（暂停/续播/倍速）',N'/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId/actions',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-record-playback/:channelId' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId/actions' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'云台基础控制',N'/api/gb28181/device-mgmt/channel/:id/ptz',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'下发巡航指令',N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'保存巡航轨迹',N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise/tracks',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/cruise/tracks' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'云台扩展控制',N'/api/gb28181/device-mgmt/channel/:id/ptz/extended',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/extended' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'云台精准控制',N'/api/gb28181/device-mgmt/channel/:id/ptz/precise',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/ptz/precise' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询设备录像',N'/api/gb28181/device-mgmt/channel/:id/record-query',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/record-query' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'创建抓拍会话',N'/api/gb28181/device-mgmt/channel/:id/snapshot-sessions',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/snapshot-sessions' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'创建对讲会话',N'/api/gb28181/device-mgmt/channel/:id/talk-sessions',N'POST',N'设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/:id/talk-sessions' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'批量删除通道',N'/api/gb28181/device-mgmt/channel/batch-delete',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/channel/batch-delete' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'创建自定义分组',N'/api/gb28181/device-mgmt/custom-groups',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/custom-groups' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'添加分组设备',N'/api/gb28181/device-mgmt/custom-groups/:id/devices',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/custom-groups/:id/devices' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'移除分组设备',N'/api/gb28181/device-mgmt/custom-groups/:id/devices/remove',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/custom-groups/:id/devices/remove' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'移动自定义分组',N'/api/gb28181/device-mgmt/custom-groups/:id/move',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/custom-groups/:id/move' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'续订设备订阅',N'/api/gb28181/device-mgmt/device/:id/subscriptions/:kind/renew',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/:id/subscriptions/:kind/renew' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'批量删除设备',N'/api/gb28181/device-mgmt/device/batch-delete',N'POST',N'设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/device/batch-delete' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'调整设备归属',N'/api/gb28181/device-mgmt/permission-workbench/assignments',N'POST',N'设备权限工作台',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-assignment' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/device-mgmt/permission-workbench/assignments' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'申请固定播放地址授权',N'/api/gb28181/play/:deviceId/:channelId/authorization',N'POST',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/play/:deviceId/:channelId/authorization' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'创建播放方案',N'/api/gb28181/playback-schemes',N'POST',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/playback-schemes' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新建录像计划',N'/api/gb28181/recording-plans',N'POST',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'提交录像计划分配',N'/api/gb28181/recording-plans/:id/assignments',N'POST',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/:id/assignments' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'生成设备接入二维码',N'/api/gb28181/sip/qr/token',N'POST',N'SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL OR (SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/platform' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/qr/token' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'暂缓 SIP 配置',N'/api/gb28181/sip/setup/skip',N'POST',N'SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/setup/skip' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'发起视频探针检测',N'/api/gb28181/stream-probes/:streamId',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/stream-probes/:streamId' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增媒体节点',N'/api/gb28181/zlm/nodes',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'激活媒体节点',N'/api/gb28181/zlm/nodes/:id/activate',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/activate' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'测试媒体节点连接',N'/api/gb28181/zlm/nodes/:id/config/test-connection',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/config/test-connection' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'停用媒体节点',N'/api/gb28181/zlm/nodes/:id/disable',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/disable' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'启用媒体节点',N'/api/gb28181/zlm/nodes/:id/enable',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/enable' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增 FFmpeg 源',N'/api/gb28181/zlm/nodes/:id/ffmpeg-sources',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/ffmpeg-sources' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'FFmpeg 源预检',N'/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key/preflight' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'踢除节点上的全部会话',N'/api/gb28181/zlm/nodes/:id/kick',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/kick' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'媒体节点维护',N'/api/gb28181/zlm/nodes/:id/maintenance',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/maintenance' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增拉流代理',N'/api/gb28181/zlm/nodes/:id/proxies/pull',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/proxies/pull' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'拉流代理预检',N'/api/gb28181/zlm/nodes/:id/proxies/pull/:key/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/proxies/pull/:key/preflight' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增推流代理',N'/api/gb28181/zlm/nodes/:id/proxies/push',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/proxies/push' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'推流代理预检',N'/api/gb28181/zlm/nodes/:id/proxies/push/:key/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/proxies/push/:key/preflight' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'强制停止录制预检',N'/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop/preflight' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'开始录制',N'/api/gb28181/zlm/nodes/:id/recordings/runtime/start',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/recordings/runtime/start' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'开始录制预检',N'/api/gb28181/zlm/nodes/:id/recordings/runtime/start/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/recordings/runtime/start/preflight' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'停止录制',N'/api/gb28181/zlm/nodes/:id/recordings/runtime/stop',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/recordings/runtime/stop' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'停止录制预检',N'/api/gb28181/zlm/nodes/:id/recordings/runtime/stop/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/recordings/runtime/stop/preflight' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增 RTP 服务',N'/api/gb28181/zlm/nodes/:id/rtp-servers',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/rtp-servers' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'关闭 RTP 服务',N'/api/gb28181/zlm/nodes/:id/rtp-servers/close',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/rtp-servers/close' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'关闭 RTP 服务预检',N'/api/gb28181/zlm/nodes/:id/rtp-servers/close/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/rtp-servers/close/preflight' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'踢除指定播放会话',N'/api/gb28181/zlm/nodes/:id/sessions/kick',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/sessions/kick' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'关闭媒体流',N'/api/gb28181/zlm/nodes/:id/streams/close',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/close' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'批量关闭媒体流',N'/api/gb28181/zlm/nodes/:id/streams/close/batch',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/close/batch' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'批量关闭媒体流预检',N'/api/gb28181/zlm/nodes/:id/streams/close/batch/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/close/batch/preflight' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'关闭媒体流预检',N'/api/gb28181/zlm/nodes/:id/streams/close/preflight',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/close/preflight' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'强制关闭媒体流',N'/api/gb28181/zlm/nodes/:id/streams/force-close',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/force-close' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'发放播放授权',N'/api/gb28181/zlm/nodes/:id/streams/playback-grant',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/streams/playback-grant' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'探测媒体节点',N'/api/gb28181/zlm/nodes/probe',N'POST',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/probe' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增插件示例',N'/api/plugins/example/add',N'POST',N'插件示例',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/plugins/example' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/plugins/example/add' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'导出插件',N'/api/pluginsmanager/export',N'POST',N'插件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/pluginsmanager' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/pluginsmanager/export' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'分片上传初始化',N'/api/sysAffix/chunk/init',N'POST',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/chunk/init' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'分片上传合并分片',N'/api/sysAffix/chunk/merge',N'POST',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/chunk/merge' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'分片上传上传分片',N'/api/sysAffix/chunk/upload',N'POST',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/chunk/upload' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'上传文件',N'/api/sysAffix/upload',N'POST',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/upload' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增API',N'/api/sysApi/add',N'POST',N'接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/api' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysApi/add' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增部门',N'/api/sysDepartment/add',N'POST',N'部门管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/division' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDepartment/add' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增字典',N'/api/sysDict/add',N'POST',N'字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDict/add' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N' 批量创建代码生成配置',N'/api/sysGen/batchInsert',N'POST',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysGen/batchInsert' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'定时任务新增',N'/api/sysJobs/add',N'POST',N'定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysJobs/add' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增菜单',N'/api/sysMenu/add',N'POST',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/add' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'设置菜单API权限',N'/api/sysMenu/setApis',N'POST',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/setApis' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'强制下线',N'/api/sysOnlineUser/forceLogout',N'POST',N'在线用户',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/online-user' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysOnlineUser/forceLogout' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增参数',N'/api/sysParam/add',N'POST',N'系统配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysparam' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysParam/add' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增角色',N'/api/sysRole/add',N'POST',N'角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysRole/add' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'添加角色的菜单权限',N'/api/sysRole/addRoleMenu',N'POST',N'角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysRole/addRoleMenu' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'新增用户',N'/api/users/add',N'POST',N'用户管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/account' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/users/add' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'上传个人头像',N'/api/users/uploadAvatar',N'POST',N'个人中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/userinfo' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/users/uploadAvatar' AND method=N'POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改系统配置',N'/api/config/update',N'PUT',N'系统配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysconfig' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/config/update' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改级联平台',N'/api/gb28181/cascade/platforms/:id',N'PUT',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms/:id' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新级联启用状态',N'/api/gb28181/cascade/platforms/:id/enabled',N'PUT',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms/:id/enabled' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新级联共享',N'/api/gb28181/cascade/platforms/:id/shares',N'PUT',N'国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/cascade/platforms/:id/shares' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'保存仪表盘布局',N'/api/gb28181/home/layout',N'PUT',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/home/layout' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'覆盖播放方案',N'/api/gb28181/playback-schemes/:id/layout',N'PUT',N'多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/playback-schemes/:id/layout' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'编辑录像计划',N'/api/gb28181/recording-plans/:id',N'PUT',N'录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/recording-plans/:id' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'启用或停用安全访问规则',N'/api/gb28181/security/access-rules/:id',N'PUT',N'国标接入安全',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/security-preview' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/security/access-rules/:id' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'保存安全防护策略',N'/api/gb28181/security/policy',N'PUT',N'国标接入安全',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/security-preview' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/security/policy' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改全局通道音频配置',N'/api/gb28181/sip/service-config/default-channel-audio',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/default-channel-audio' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'设置默认码流传输方式',N'/api/gb28181/sip/service-config/default-channel-stream-transport',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/default-channel-stream-transport' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改默认播放协议',N'/api/gb28181/sip/service-config/default-playback-protocol',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/default-playback-protocol' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改固定地址播放配置',N'/api/gb28181/sip/service-config/fixed-address-playback',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/fixed-address-playback' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改全局订阅项目',N'/api/gb28181/sip/service-config/global-subscriptions',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/global-subscriptions' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改忽略通道离线异常通知配置',N'/api/gb28181/sip/service-config/ignore-channel-offline-status-notify',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/ignore-channel-offline-status-notify' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改收到心跳恢复设备上线配置',N'/api/gb28181/sip/service-config/online-on-heartbeat',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/online-on-heartbeat' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改播放鉴权配置',N'/api/gb28181/sip/service-config/play-auth',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/play-auth' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改回放参数',N'/api/gb28181/sip/service-config/playback-settings',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/playback-settings' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改移动位置历史轨迹配置',N'/api/gb28181/sip/service-config/position-history',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/position-history' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改预分配模式',N'/api/gb28181/sip/service-config/preallocation-mode',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/preallocation-mode' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改云台默认速度配置',N'/api/gb28181/sip/service-config/ptz-default-speed',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/ptz-default-speed' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改报警消息存储配置',N'/api/gb28181/sip/service-config/save-alarm-messages',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/save-alarm-messages' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'设置 SDP 扩展参数',N'/api/gb28181/sip/service-config/sdp-extension',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/sdp-extension' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改 SIP 命令超时时间',N'/api/gb28181/sip/service-config/sip-command-timeout',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/sip-command-timeout' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改 SIP 日志配置',N'/api/gb28181/sip/service-config/sip-log',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/sip-log' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改设备上线同步通道配置',N'/api/gb28181/sip/service-config/sync-channels-on-online',N'PUT',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/sync-channels-on-online' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'保存 SIP 配置',N'/api/gb28181/sip/setup/config',N'PUT',N'SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/setup/config' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新媒体节点',N'/api/gb28181/zlm/nodes/:id',N'PUT',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新媒体服务配置',N'/api/gb28181/zlm/nodes/:id/config',N'PUT',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/nodes/:id/config' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新媒体调度策略',N'/api/gb28181/zlm/scheduler',N'PUT',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/media/scheduling' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/scheduler' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改',N'/api/plugins/example/edit',N'PUT',N'插件示例',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/plugins/example' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/plugins/example/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改文件名',N'/api/sysAffix/updateName',N'PUT',N'文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysAffix/updateName' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新API',N'/api/sysApi/edit',N'PUT',N'接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/api' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysApi/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'编辑部门',N'/api/sysDepartment/edit',N'PUT',N'部门管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/division' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDepartment/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新字典',N'/api/sysDict/edit',N'PUT',N'字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDict/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'编辑字典项',N'/api/sysDictItem/edit',N'PUT',N'字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysDictItem/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'同步数据库',N'/api/sysGen/refreshFields',N'PUT',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysGen/refreshFields' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新代码生成配置和字段信息',N'/api/sysGen/update',N'PUT',N'代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysGen/update' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'定时任务编辑',N'/api/sysJobs/edit',N'PUT',N'定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysJobs/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'定时任务设置任务状态',N'/api/sysJobs/setStatus',N'PUT',N'定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysJobs/setStatus' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新菜单',N'/api/sysMenu/edit',N'PUT',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'编辑参数',N'/api/sysParam/edit',N'PUT',N'系统配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/sysparam' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysParam/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'设置数据权限',N'/api/sysRole/dataScope',N'PUT',N'角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysRole/dataScope' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新角色',N'/api/sysRole/edit',N'PUT',N'角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/sysRole/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'更新用户信息',N'/api/users/edit',N'PUT',N'用户管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/account' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/users/edit' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改密码、手机号等',N'/api/users/updateAccount',N'PUT',N'个人中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/userinfo' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/users/updateAccount' AND method=N'PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'修改用户基本信息',N'/api/users/updateBasicInfo',N'PUT',N'个人中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path=N'/system/userinfo' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/users/updateBasicInfo' AND method=N'PUT' AND deleted_at IS NULL);
...
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:play:diagnose' AND m.type=3 AND m.deleted_at IS NULL AND a.path=N'/api/gb28181/stream-probes/operations/:operationId' AND a.method=N'GET' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api ma WHERE ma.menu_id=m.id AND ma.api_id=a.id);
...
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:zlm:node:manage' AND m.type=3 AND m.deleted_at IS NULL AND a.path=N'/api/gb28181/zlm/nodes/:id/disable' AND a.method=N'POST' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api ma WHERE ma.menu_id=m.id AND ma.api_id=a.id);

INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:zlm:node:manage' AND m.type=3 AND m.deleted_at IS NULL AND a.path=N'/api/gb28181/zlm/nodes/:id/enable' AND a.method=N'POST' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api ma WHERE ma.menu_id=m.id AND ma.api_id=a.id);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'获取当前用户信息',N'/api/users/profile',N'GET',N'个人中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS(SELECT 1 FROM sys_api WHERE path=N'/api/users/profile' AND method=N'GET' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'获取用户权限菜单',N'/api/sysMenu/getRouters',N'GET',N'菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS(SELECT 1 FROM sys_api WHERE path=N'/api/sysMenu/getRouters' AND method=N'GET' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'用户登出',N'/api/users/logout',N'POST',N'认证管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS(SELECT 1 FROM sys_api WHERE path=N'/api/users/logout' AND method=N'POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取 SIP 仪表盘快照',N'/api/gb28181/sip/dashboard/snapshot',N'GET',N'仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS(SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/dashboard/snapshot' AND method=N'GET' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看媒体服务总览',N'/api/gb28181/zlm/overview',N'GET',N'流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS(SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/zlm/overview' AND method=N'GET' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'读取回放参数',N'/api/gb28181/sip/service-config/playback-settings',N'GET',N'国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS(SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/sip/service-config/playback-settings' AND method=N'GET' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by)
SELECT N'查询视频探针任务',N'/api/gb28181/stream-probes/operations/:operationId',N'GET',N'按钮权限目录',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1
WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/stream-probes/operations/:operationId' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_menu_api(menu_id,api_id)
SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a
WHERE m.permission=N'gb28181:play:diagnose' AND m.type=3 AND m.deleted_at IS NULL
  AND a.path=N'/api/gb28181/stream-probes/operations/:operationId' AND a.method=N'GET' AND a.deleted_at IS NULL
  AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_casbin_rule(ptype,v0,v1,v2,v3,v4,v5)
SELECT DISTINCT 'p',CONCAT('role_',rm.role_id),a.path,a.method,'*','',''
...
WHERE m.permission=N'gb28181:play:diagnose' AND a.path=N'/api/gb28181/stream-probes/operations/:operationId' AND a.method=N'GET'
...
IF NOT EXISTS (SELECT 1 FROM [sys_menu] WHERE [path]='/system/realtime-log' AND [deleted_at] IS NULL) INSERT INTO [sys_menu] ([parent_id],[path],[name],[redirect],[component],[title],[is_full],[hide],[disable],[keep_alive],[affix],[link],[iframe],[svg_icon],[icon],[sort],[type],[is_link],[permission],[created_by],[created_at],[updated_at]) VALUES (10,'/system/realtime-log','gb28181-realtime-log','','gb28181/realtime-log/index',N'实时日志控制台',0,0,0,0,0,'',0,'','',2,2,0,'gb28181:log:view',1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP);
INSERT INTO [sys_role_menu] ([role_id],[menu_id]) SELECT 1,m.[id] FROM [sys_menu] m WHERE m.[path]='/system/realtime-log' AND m.[deleted_at] IS NULL AND NOT EXISTS (SELECT 1 FROM [sys_role_menu] x WHERE x.[role_id]=1 AND x.[menu_id]=m.[id]);

-- ───────────────────────────────────────────────────────────────
-- 2026-09-15 重排一级菜单展示顺序（同步自 migrations/2026-09-15-reorder-top-level-menus-sqlserver.sql）
...
-- scheduler-permission-parent:start
-- 调度策略已并入节点管理：迁移按钮权限归属并重命名独立日志菜单。
UPDATE [sys_menu]
...
-- scheduler-permission-parent:end

-- log-center-menu:start（同步自 migrations/2026-09-17-log-center-menu-sqlserver.sql）
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看 OpenAPI 客户端列表',N'/api/gb28181/openapi-clients',N'GET',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'创建 OpenAPI 客户端',N'/api/gb28181/openapi-clients',N'POST',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients' AND method=N'POST' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看 OpenAPI 能力目录',N'/api/gb28181/openapi-clients/capabilities',N'GET',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/capabilities' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看 OpenAPI 客户端详情',N'/api/gb28181/openapi-clients/:id',N'GET',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'分配 OpenAPI 客户端能力',N'/api/gb28181/openapi-clients/:id/scopes',N'PUT',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id/scopes' AND method=N'PUT' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'轮换 OpenAPI 客户端密钥',N'/api/gb28181/openapi-clients/:id/rotate-secret',N'POST',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id/rotate-secret' AND method=N'POST' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'启用 OpenAPI 客户端',N'/api/gb28181/openapi-clients/:id/enable',N'POST',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id/enable' AND method=N'POST' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'停用 OpenAPI 客户端',N'/api/gb28181/openapi-clients/:id/disable',N'POST',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id/disable' AND method=N'POST' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'撤销 OpenAPI 客户端',N'/api/gb28181/openapi-clients/:id/revoke',N'POST',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id/revoke' AND method=N'POST' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看 OpenAPI 客户端审计',N'/api/gb28181/openapi-clients/:id/audits',N'GET',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id/audits' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查看 OpenAPI 客户端撤销进度',N'/api/gb28181/openapi-clients/:id/revocation-status',N'GET',N'GB28181 OpenAPI 客户端',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/openapi-clients/:id/revocation-status' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by) SELECT 0,N'',N'Permission_gb28181_openapi_client_read',N'',N'查看 OpenAPI 客户端',1,0,100,3,N'gb28181:openapi:client:read',N'',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE permission=N'gb28181:openapi:client:read' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by) SELECT 0,N'',N'Permission_gb28181_openapi_client_create',N'',N'创建 OpenAPI 客户端',1,0,100,3,N'gb28181:openapi:client:create',N'',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE permission=N'gb28181:openapi:client:create' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by) SELECT 0,N'',N'Permission_gb28181_openapi_client_grant',N'',N'分配 OpenAPI 客户端能力',1,0,100,3,N'gb28181:openapi:client:grant',N'',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE permission=N'gb28181:openapi:client:grant' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by) SELECT 0,N'',N'Permission_gb28181_openapi_client_rotate',N'',N'轮换 OpenAPI 客户端密钥',1,0,100,3,N'gb28181:openapi:client:rotate',N'',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE permission=N'gb28181:openapi:client:rotate' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by) SELECT 0,N'',N'Permission_gb28181_openapi_client_status',N'',N'启停或撤销 OpenAPI 客户端',1,0,100,3,N'gb28181:openapi:client:status',N'',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE permission=N'gb28181:openapi:client:status' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by) SELECT 0,N'',N'Permission_gb28181_openapi_client_audit',N'',N'查看 OpenAPI 客户端审计',1,0,100,3,N'gb28181:openapi:client:audit',N'',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE permission=N'gb28181:openapi:client:audit' AND deleted_at IS NULL);
INSERT INTO sys_role_menu(role_id,menu_id) SELECT r.id,m.id FROM sys_role r CROSS JOIN sys_menu m WHERE r.id=1 AND r.status=1 AND r.deleted_at IS NULL AND m.permission IN (N'gb28181:openapi:client:read',N'gb28181:openapi:client:create',N'gb28181:openapi:client:grant',N'gb28181:openapi:client:rotate',N'gb28181:openapi:client:status',N'gb28181:openapi:client:audit') AND m.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_role_menu x WHERE x.role_id=r.id AND x.menu_id=m.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:openapi:client:read' AND m.deleted_at IS NULL AND a.deleted_at IS NULL AND ((a.path=N'/api/gb28181/openapi-clients' AND a.method=N'GET') OR (a.path=N'/api/gb28181/openapi-clients/capabilities' AND a.method=N'GET') OR (a.path=N'/api/gb28181/openapi-clients/:id' AND a.method=N'GET')) AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:openapi:client:create' AND a.path=N'/api/gb28181/openapi-clients' AND a.method=N'POST' AND m.deleted_at IS NULL AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:openapi:client:grant' AND a.path=N'/api/gb28181/openapi-clients/:id/scopes' AND a.method=N'PUT' AND m.deleted_at IS NULL AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:openapi:client:rotate' AND a.path=N'/api/gb28181/openapi-clients/:id/rotate-secret' AND a.method=N'POST' AND m.deleted_at IS NULL AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:openapi:client:status' AND m.deleted_at IS NULL AND a.deleted_at IS NULL AND ((a.path=N'/api/gb28181/openapi-clients/:id/enable' AND a.method=N'POST') OR (a.path=N'/api/gb28181/openapi-clients/:id/disable' AND a.method=N'POST') OR (a.path=N'/api/gb28181/openapi-clients/:id/revoke' AND a.method=N'POST') OR (a.path=N'/api/gb28181/openapi-clients/:id/revocation-status' AND a.method=N'GET')) AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
...
-- NVARCHAR is UTF-16: DB limit is 32768 code units; the application additionally
-- enforces the stricter 32768-byte UTF-8 canonical JSON budget before every write.
IF OBJECT_ID(N'dbo.gb_device_operation_intent', N'U') IS NULL THROW 51000, N'SIP INVITE steps require device operation intent', 1;
IF COL_LENGTH(N'dbo.gb_device_operation_intent', N'sip_steps_json') IS NULL ALTER TABLE dbo.gb_device_operation_intent ADD sip_steps_json NVARCHAR(MAX) NULL;
IF NOT EXISTS (SELECT 1 FROM sys.check_constraints WHERE parent_object_id = OBJECT_ID(N'dbo.gb_device_operation_intent') AND name = N'ck_device_intent_sip_size') ALTER TABLE dbo.gb_device_operation_intent ADD CONSTRAINT ck_device_intent_sip_size CHECK (sip_steps_json IS NULL OR DATALENGTH(sip_steps_json) BETWEEN 2 AND 65536);
...
-- target-track:start（同步自 migrations/2026-09-21-target-track.sql）
-- GB/T 28181-2022 A.2.3.1.14「目标跟踪控制命令」的落库表 = **平台已下发意图**，
-- (device_id, target_code) 一行。⛔ 它不是设备状态：目标跟踪是无应答命令
-- （9.3.1 d) + 表 1 序号 13），且 2022 全文没有"目标跟踪状态查询/上报"的命令。
...
-- target-track-permissions:start（同步自 migrations/2026-09-21-target-track.sql）
-- 读 GET → gb28181:ptz:view；写 POST → gb28181:ptz:control（照 video-params 先例按方法分档）。
-- ⛔ 本块**不新建** sys_menu 权限点：读写分别复用既有的两个云台权限码。
INSERT INTO [sys_api] ([title],[path],[method],[api_group],[created_at],[updated_at],[created_by])
...
-- realtime-log-menu-rename:start（同步自 migrations/2026-09-21-rename-realtime-log-menu-title-sqlserver.sql）
-- 将「实时日志控制台」更名为「运行日志」。
-- 依据：该菜单位于「日志中心」(/log-center) 下，同级为 SIP 日志 / 登录日志 / 操作日志 /
-- 定时任务日志，命名应为「X日志」同构；「实时」在同级四个同样实时可查的菜单前没有区分度，
-- 「控制台」描述的是展示形式(终端 UI)而非内容。该页镜像后端进程 stdout，
-- 「运行日志」与数据源一致。
-- ⛔ 按 permission 定位而非 path：菜单 path 已由 2026-09-15 块从
--    /gb28181/realtime-log 移至 /system/realtime-log。
UPDATE [sys_menu] SET [title]=N'运行日志',[updated_at]=CURRENT_TIMESTAMP
WHERE [permission]=N'gb28181:log:view' AND [deleted_at] IS NULL AND [title]<>N'运行日志';
-- realtime-log-menu-rename:end

-- realtime-log-menu-icon:start（同步自 migrations/2026-09-21-realtime-log-menu-icon-sqlserver.sql）
-- 补齐该菜单图标：基线历史块种出的这行 icon 为空，而同组 SIP 日志 / 登录日志 / 操作日志 /
-- 定时任务日志 的 icon 都由各自建菜单段带上 —— 只有它是漏的。
-- 前端 menu-item-icon.vue 三级回落（lucide icon → svg_icon → icon 组件），
-- icon 为空 ⇒ 三条全落空 ⇒ 图标区整块不渲染，且不报错。
-- 取 lucide:Terminal：该页镜像后端进程 stdout（页面本体即终端）。
-- ⛔ 按 permission 定位而非 path。
-- ⛔ 同时确认 Terminal 已在 web/src/utils/lucide-menu-icons.ts 白名单注册，
--    未注册的 lucide 名会静默无图标（不报错、也不回退 svg_icon）。
UPDATE [sys_menu] SET [icon]=N'lucide:Terminal',[updated_at]=CURRENT_TIMESTAMP
WHERE [permission]=N'gb28181:log:view' AND [deleted_at] IS NULL
  AND ([icon] IS NULL OR [icon]<>N'lucide:Terminal');
-- realtime-log-menu-icon:end
...
-- ==== 2026-09-21 API 分组重定口径（判定键改为接口路径）====
...
UPDATE [sys_api] SET [api_group]=N'认证管理' WHERE [path]='/api/login' AND [method]='POST' AND [api_group]<>N'认证管理';
UPDATE [sys_api] SET [api_group]=N'认证管理' WHERE [path]='/api/refreshToken' AND [method]='POST' AND [api_group]<>N'认证管理';
UPDATE [sys_api] SET [api_group]=N'认证管理' WHERE [path]='/api/captcha/id' AND [method]='GET' AND [api_group]<>N'认证管理';
UPDATE [sys_api] SET [api_group]=N'认证管理' WHERE [path]='/api/captcha/image' AND [method]='GET' AND [api_group]<>N'认证管理';
UPDATE [sys_api] SET [api_group]=N'认证管理' WHERE [path]='/api/users/logout' AND [method]='POST' AND [api_group]<>N'认证管理';
UPDATE [sys_api] SET [api_group]=N'个人中心' WHERE [path]='/api/users/profile' AND [method]='GET' AND [api_group]<>N'个人中心';
UPDATE [sys_api] SET [api_group]=N'用户管理' WHERE [path]='/api/users/:id' AND [method]='GET' AND [api_group]<>N'用户管理';
UPDATE [sys_api] SET [api_group]=N'用户管理' WHERE [path]='/api/users/list' AND [method]='GET' AND [api_group]<>N'用户管理';
UPDATE [sys_api] SET [api_group]=N'用户管理' WHERE [path]='/api/users/add' AND [method]='POST' AND [api_group]<>N'用户管理';
UPDATE [sys_api] SET [api_group]=N'用户管理' WHERE [path]='/api/users/edit' AND [method]='PUT' AND [api_group]<>N'用户管理';
UPDATE [sys_api] SET [api_group]=N'用户管理' WHERE [path]='/api/users/delete' AND [method]='DELETE' AND [api_group]<>N'用户管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/getRouters' AND [method]='GET' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/getMenuList' AND [method]='GET' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/:id' AND [method]='GET' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/add' AND [method]='POST' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/edit' AND [method]='PUT' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/delete' AND [method]='DELETE' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'部门管理' WHERE [path]='/api/sysDepartment/getDivision' AND [method]='GET' AND [api_group]<>N'部门管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/getRoles' AND [method]='GET' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/getUserPermission/:roleId' AND [method]='GET' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/addRoleMenu' AND [method]='POST' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/list' AND [method]='GET' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/:id' AND [method]='GET' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/add' AND [method]='POST' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/edit' AND [method]='PUT' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/delete' AND [method]='DELETE' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDict/getAllDicts' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDict/getByCode/:code' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'接口管理' WHERE [path]='/api/sysApi/list' AND [method]='GET' AND [api_group]<>N'接口管理';
UPDATE [sys_api] SET [api_group]=N'接口管理' WHERE [path]='/api/sysApi/:id' AND [method]='GET' AND [api_group]<>N'接口管理';
UPDATE [sys_api] SET [api_group]=N'接口管理' WHERE [path]='/api/sysApi/add' AND [method]='POST' AND [api_group]<>N'接口管理';
UPDATE [sys_api] SET [api_group]=N'接口管理' WHERE [path]='/api/sysApi/edit' AND [method]='PUT' AND [api_group]<>N'接口管理';
UPDATE [sys_api] SET [api_group]=N'接口管理' WHERE [path]='/api/sysApi/delete' AND [method]='DELETE' AND [api_group]<>N'接口管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/apis/:id' AND [method]='GET' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/setApis' AND [method]='POST' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'部门管理' WHERE [path]='/api/sysDepartment/:id' AND [method]='GET' AND [api_group]<>N'部门管理';
UPDATE [sys_api] SET [api_group]=N'部门管理' WHERE [path]='/api/sysDepartment/add' AND [method]='POST' AND [api_group]<>N'部门管理';
UPDATE [sys_api] SET [api_group]=N'部门管理' WHERE [path]='/api/sysDepartment/edit' AND [method]='PUT' AND [api_group]<>N'部门管理';
UPDATE [sys_api] SET [api_group]=N'部门管理' WHERE [path]='/api/sysDepartment/delete' AND [method]='DELETE' AND [api_group]<>N'部门管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDict/list' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDict/:id' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDict/add' AND [method]='POST' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDict/edit' AND [method]='PUT' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDict/delete' AND [method]='DELETE' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDictItem/list' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDictItem/:id' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDictItem/getByDictId/:dictId' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDictItem/getByDictCode/:dictCode' AND [method]='GET' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDictItem/add' AND [method]='POST' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDictItem/edit' AND [method]='PUT' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'字典管理' WHERE [path]='/api/sysDictItem/delete' AND [method]='DELETE' AND [api_group]<>N'字典管理';
UPDATE [sys_api] SET [api_group]=N'个人中心' WHERE [path]='/api/users/updateAccount' AND [method]='PUT' AND [api_group]<>N'个人中心';
UPDATE [sys_api] SET [api_group]=N'个人中心' WHERE [path]='/api/users/uploadAvatar' AND [method]='POST' AND [api_group]<>N'个人中心';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/upload' AND [method]='POST' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/delete' AND [method]='DELETE' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/updateName' AND [method]='PUT' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/list' AND [method]='GET' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/:id' AND [method]='GET' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/download/:id' AND [method]='GET' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'角色管理' WHERE [path]='/api/sysRole/dataScope' AND [method]='PUT' AND [api_group]<>N'角色管理';
UPDATE [sys_api] SET [api_group]=N'系统配置' WHERE [path]='/api/config/get' AND [method]='GET' AND [api_group]<>N'系统配置';
UPDATE [sys_api] SET [api_group]=N'系统配置' WHERE [path]='/api/config/update' AND [method]='PUT' AND [api_group]<>N'系统配置';
UPDATE [sys_api] SET [api_group]=N'系统配置' WHERE [path]='/api/config/viewCache' AND [method]='GET' AND [api_group]<>N'系统配置';
UPDATE [sys_api] SET [api_group]=N'插件示例' WHERE [path]='/api/plugins/example/list' AND [method]='GET' AND [api_group]<>N'插件示例';
UPDATE [sys_api] SET [api_group]=N'插件示例' WHERE [path]='/api/plugins/example/add' AND [method]='POST' AND [api_group]<>N'插件示例';
UPDATE [sys_api] SET [api_group]=N'插件示例' WHERE [path]='/api/plugins/example/edit' AND [method]='PUT' AND [api_group]<>N'插件示例';
UPDATE [sys_api] SET [api_group]=N'插件示例' WHERE [path]='/api/plugins/example/delete' AND [method]='DELETE' AND [api_group]<>N'插件示例';
UPDATE [sys_api] SET [api_group]=N'插件示例' WHERE [path]='/api/plugins/example/:id' AND [method]='GET' AND [api_group]<>N'插件示例';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysOperationLog/list' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysOperationLog/delete' AND [method]='DELETE' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysOperationLog/export' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/export' AND [method]='GET' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/import' AND [method]='POST' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'个人中心' WHERE [path]='/api/users/updateBasicInfo' AND [method]='PUT' AND [api_group]<>N'个人中心';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/codegen/generate' AND [method]='POST' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/codegen/columns' AND [method]='GET' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/codegen/databases' AND [method]='GET' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/codegen/tables' AND [method]='GET' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/codegen/preview' AND [method]='GET' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/sysGen/list' AND [method]='GET' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/sysGen/batchInsert' AND [method]='POST' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/sysGen/:id' AND [method]='GET' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/sysGen/update' AND [method]='PUT' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/sysGen/:id' AND [method]='DELETE' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/sysGen/refreshFields' AND [method]='PUT' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'代码生成' WHERE [path]='/api/codegen/insertmenuandapi' AND [method]='POST' AND [api_group]<>N'代码生成';
UPDATE [sys_api] SET [api_group]=N'菜单管理' WHERE [path]='/api/sysMenu/batchDelete' AND [method]='DELETE' AND [api_group]<>N'菜单管理';
UPDATE [sys_api] SET [api_group]=N'插件管理' WHERE [path]='/api/pluginsmanager/exports' AND [method]='GET' AND [api_group]<>N'插件管理';
UPDATE [sys_api] SET [api_group]=N'插件管理' WHERE [path]='/api/pluginsmanager/export' AND [method]='POST' AND [api_group]<>N'插件管理';
UPDATE [sys_api] SET [api_group]=N'插件管理' WHERE [path]='/api/pluginsmanager/import' AND [method]='POST' AND [api_group]<>N'插件管理';
UPDATE [sys_api] SET [api_group]=N'插件管理' WHERE [path]='/api/pluginsmanager/uninstall' AND [method]='DELETE' AND [api_group]<>N'插件管理';
UPDATE [sys_api] SET [api_group]=N'用户管理' WHERE [path]='/api/users/switchTenant/:tenantld' AND [method]='GET' AND [api_group]<>N'用户管理';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/list' AND [method]='GET' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/executors' AND [method]='GET' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/add' AND [method]='POST' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/edit' AND [method]='PUT' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/:id' AND [method]='GET' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/setStatus' AND [method]='PUT' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/delete' AND [method]='DELETE' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'定时任务' WHERE [path]='/api/sysJobs/executeNow' AND [method]='POST' AND [api_group]<>N'定时任务';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysJobResults/list' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysJobResults/delete' AND [method]='DELETE' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/chunk/init' AND [method]='POST' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/chunk/upload' AND [method]='POST' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/chunk/merge' AND [method]='POST' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'文件管理' WHERE [path]='/api/sysAffix/chunk/cancel' AND [method]='DELETE' AND [api_group]<>N'文件管理';
UPDATE [sys_api] SET [api_group]=N'SIP 接入信息' WHERE [path]='/api/gb28181/sip/setup/status' AND [method]='GET' AND [api_group]<>N'SIP 接入信息';
UPDATE [sys_api] SET [api_group]=N'SIP 接入信息' WHERE [path]='/api/gb28181/sip/setup/network-interfaces' AND [method]='GET' AND [api_group]<>N'SIP 接入信息';
UPDATE [sys_api] SET [api_group]=N'SIP 接入信息' WHERE [path]='/api/gb28181/sip/platform' AND [method]='GET' AND [api_group]<>N'SIP 接入信息';
UPDATE [sys_api] SET [api_group]=N'SIP 接入信息' WHERE [path]='/api/gb28181/sip/setup/config' AND [method]='PUT' AND [api_group]<>N'SIP 接入信息';
UPDATE [sys_api] SET [api_group]=N'SIP 接入信息' WHERE [path]='/api/gb28181/sip/setup/skip' AND [method]='POST' AND [api_group]<>N'SIP 接入信息';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/sip-traces/health' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/sip-traces/messages' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/sip-traces/messages/:id' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/sip-traces/sessions' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/sip-traces/sessions/:callId/messages' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/device-mgmt/device/:id/sip-trace-capture' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/device-mgmt/device/:id/sip-trace-captures' AND [method]='POST' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/sip-traces/captures/:id/stop' AND [method]='POST' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'SIP 接入信息' WHERE [path]='/api/gb28181/sip/qr/token' AND [method]='POST' AND [api_group]<>N'SIP 接入信息';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/custom-groups' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/custom-groups/:id' AND [method]='PATCH' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/custom-groups/:id/move' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/custom-groups/:id' AND [method]='DELETE' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/custom-groups/:id/devices' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/custom-groups/:id/devices/remove' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'告警管理' WHERE [path]='/api/gb28181/alarms' AND [method]='GET' AND [api_group]<>N'告警管理';
UPDATE [sys_api] SET [api_group]=N'告警管理' WHERE [path]='/api/gb28181/alarms/:id' AND [method]='GET' AND [api_group]<>N'告警管理';
UPDATE [sys_api] SET [api_group]=N'告警管理' WHERE [path]='/api/gb28181/alarms/:id' AND [method]='DELETE' AND [api_group]<>N'告警管理';
UPDATE [sys_api] SET [api_group]=N'告警管理' WHERE [path]='/api/gb28181/alarms/batch-delete' AND [method]='POST' AND [api_group]<>N'告警管理';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/position-history' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/position-history' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/playback-schemes' AND [method]='GET' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/playback-schemes/:id' AND [method]='GET' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/playback-schemes' AND [method]='POST' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/playback-schemes/:id' AND [method]='PATCH' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/playback-schemes/:id/layout' AND [method]='PUT' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/playback-schemes/:id' AND [method]='DELETE' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/ptz-default-speed' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/ptz-default-speed' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/sync-channels-on-online' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/sync-channels-on-online' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/sip-log' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/sip-log' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/ignore-channel-offline-status-notify' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/ignore-channel-offline-status-notify' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/online-on-heartbeat' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/online-on-heartbeat' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/save-alarm-messages' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/save-alarm-messages' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/sip-command-timeout' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/sip-command-timeout' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/preallocation-mode' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/preallocation-mode' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/snapshot' AND [method]='GET' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/events' AND [method]='GET' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/bans' AND [method]='GET' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/bans/:id/unban' AND [method]='POST' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/policy' AND [method]='GET' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/policy' AND [method]='PUT' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/agent/health' AND [method]='GET' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/stream' AND [method]='GET' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/access-rules' AND [method]='GET' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/access-rules' AND [method]='POST' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/access-rules/:id' AND [method]='PUT' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标接入安全' WHERE [path]='/api/gb28181/security/access-rules/:id' AND [method]='DELETE' AND [api_group]<>N'国标接入安全';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/global-subscriptions' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/global-subscriptions' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/default-channel-audio' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/default-channel-audio' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/default-playback-protocol' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/default-playback-protocol' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/fixed-address-playback' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/fixed-address-playback' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/files' AND [method]='GET' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/files/options' AND [method]='GET' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/files/:id' AND [method]='GET' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/files/:id/access' AND [method]='POST' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/active' AND [method]='GET' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/reconciliations' AND [method]='GET' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/reconciliations' AND [method]='POST' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms' AND [method]='GET' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms' AND [method]='POST' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id' AND [method]='GET' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id' AND [method]='PUT' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id' AND [method]='DELETE' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/enable' AND [method]='POST' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/disable' AND [method]='POST' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/enabled' AND [method]='PUT' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/shares' AND [method]='GET' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/shares' AND [method]='PUT' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/play-auth' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/play-auth' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/play/:deviceId/:channelId/authorization' AND [method]='POST' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/play/:deviceId/:channelId' AND [method]='POST' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/files/:id/downloads' AND [method]='POST' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/downloads/:taskId' AND [method]='GET' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/downloads/:taskId' AND [method]='DELETE' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-traffic/summary' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-traffic/trend' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-traffic/realtime' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-traffic/sessions' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-traffic/coverage' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-traffic/viewers' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-traffic/viewers/kick' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'在线用户' WHERE [path]='/api/sysOnlineUser/list' AND [method]='GET' AND [api_group]<>N'在线用户';
UPDATE [sys_api] SET [api_group]=N'在线用户' WHERE [path]='/api/sysOnlineUser/forceLogout' AND [method]='POST' AND [api_group]<>N'在线用户';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysLoginLog/list' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysLoginLog/:id' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysLoginLog/delete' AND [method]='DELETE' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysLoginLog/clear' AND [method]='POST' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/sysLoginLog/unlock' AND [method]='POST' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/channel-favorite-groups' AND [method]='GET' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/channel-favorite-groups' AND [method]='POST' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/channel-favorite-groups/:id/channels' AND [method]='POST' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/channel-favorite-groups/:id/channels' AND [method]='DELETE' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/channel-favorite-groups/:id' AND [method]='DELETE' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'设备权限工作台' WHERE [path]='/api/gb28181/device-mgmt/permission-workbench/summary' AND [method]='GET' AND [api_group]<>N'设备权限工作台';
UPDATE [sys_api] SET [api_group]=N'设备权限工作台' WHERE [path]='/api/gb28181/device-mgmt/permission-workbench/devices/resolve' AND [method]='POST' AND [api_group]<>N'设备权限工作台';
UPDATE [sys_api] SET [api_group]=N'设备权限工作台' WHERE [path]='/api/gb28181/device-mgmt/permission-workbench/grants/query' AND [method]='POST' AND [api_group]<>N'设备权限工作台';
UPDATE [sys_api] SET [api_group]=N'设备权限工作台' WHERE [path]='/api/gb28181/device-mgmt/permission-workbench/grant-targets' AND [method]='GET' AND [api_group]<>N'设备权限工作台';
UPDATE [sys_api] SET [api_group]=N'设备权限工作台' WHERE [path]='/api/gb28181/device-mgmt/permission-workbench/assignments' AND [method]='POST' AND [api_group]<>N'设备权限工作台';
UPDATE [sys_api] SET [api_group]=N'设备权限工作台' WHERE [path]='/api/gb28181/device-mgmt/permission-workbench/assignments/departments' AND [method]='POST' AND [api_group]<>N'设备权限工作台';
UPDATE [sys_api] SET [api_group]=N'设备权限工作台' WHERE [path]='/api/gb28181/device-mgmt/permission-workbench/grants/apply' AND [method]='POST' AND [api_group]<>N'设备权限工作台';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/files/:id' AND [method]='DELETE' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/files/batch-delete' AND [method]='POST' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'云端录像' WHERE [path]='/api/gb28181/cloud-recordings/active/:id/stop' AND [method]='POST' AND [api_group]<>N'云端录像';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans' AND [method]='GET' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans' AND [method]='POST' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id' AND [method]='GET' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id' AND [method]='PUT' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id' AND [method]='DELETE' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id/status' AND [method]='PATCH' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id/assignment-options/devices' AND [method]='GET' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id/assignment-options/channels' AND [method]='GET' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id/assignments' AND [method]='POST' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/channels/:channelId/recording-mode' AND [method]='PATCH' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/:id/channels' AND [method]='GET' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/channels/:channelId/diagnosis' AND [method]='GET' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'录像计划' WHERE [path]='/api/gb28181/recording-plans/channels/:channelId/timeline' AND [method]='GET' AND [api_group]<>N'录像计划';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/overview' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/config' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/scheduler' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/scheduler/logs' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/runtime' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/streams' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/detail' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/viewers' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/sessions/network' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/sessions/viewers' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/pull' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/pull/:key' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/push' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/push/:key' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/ffmpeg-sources' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/rtp-servers' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/recordings/runtime/status' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id' AND [method]='PUT' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id' AND [method]='DELETE' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/maintenance' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/activate' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/kick' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/scheduler' AND [method]='PUT' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/playback-grant' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/snapshot' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/close/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/close' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/close/batch/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/close/batch' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/streams/force-close' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/sessions/kick' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/pull' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/pull/:key/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/pull/:key' AND [method]='DELETE' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/push' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/push/:key/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/proxies/push/:key' AND [method]='DELETE' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/ffmpeg-sources' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key' AND [method]='DELETE' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/rtp-servers' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/rtp-servers/close/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/rtp-servers/close' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/rtp-servers/force-close' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/recordings/runtime/start/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/recordings/runtime/start' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/recordings/runtime/stop/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/recordings/runtime/stop' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop/preflight' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/config' AND [method]='PUT' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/config/test-connection' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/restart' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/restart' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/maintenance-operations' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/reboot' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/firmware-upgrades' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/firmware-upgrade' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id' AND [method]='DELETE' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId' AND [method]='DELETE' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/presets/:presetId' AND [method]='DELETE' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/talk-sessions/:sessionId' AND [method]='DELETE' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id' AND [method]='DELETE' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/home/layout' AND [method]='DELETE' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]='/api/gb28181/play/:streamId' AND [method]='DELETE' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'系统配置' WHERE [path]='/api/sysParam/delete' AND [method]='DELETE' AND [api_group]<>N'系统配置';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/catalog/tree' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/catalog/tree/:id' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/catalog/tree/:id/children' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/control-capabilities' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/device-status' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/mounts' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/cruise-tracks' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/cruise-tracks/:trackId' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/home-position' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/operations/:operationId' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/precise-status' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/presets' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/record-query/options' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/snapshot-sessions/:sessionId' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/talk-sessions/:sessionId' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/timeline' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channels' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/status-events' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/subscriptions' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/devices' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/directory/tree' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/map/clusters' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/map/markers' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/home/drilldown/play' AND [method]='GET' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/home/drilldown/sip' AND [method]='GET' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/home/drilldown/traffic' AND [method]='GET' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/home/layout' AND [method]='GET' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/home/summary' AND [method]='GET' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/play/:streamId/monitor' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id' AND [method]='PATCH' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/cloud-recording' AND [method]='PATCH' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/home-position' AND [method]='PATCH' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/stream-transport' AND [method]='PATCH' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/subscriptions/:kind' AND [method]='PATCH' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device/:deviceId' AND [method]='PATCH' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'告警管理' WHERE [path]='/api/gb28181/alarms/clear-all' AND [method]='POST' AND [api_group]<>N'告警管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/device-control' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/download-sessions' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/playback-sessions' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId/actions' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/cruise' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/cruise/tracks' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/extended' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/precise' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/presets' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/ptz/presets/:presetId/call' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/record-query' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/snapshot-sessions' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/talk-sessions' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/batch-delete' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/catalog/refresh' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/:id/subscriptions/:kind/renew' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/device/batch-delete' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/probe' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'系统配置' WHERE [path]='/api/sysParam/add' AND [method]='POST' AND [api_group]<>N'系统配置';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/home/layout' AND [method]='PUT' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/default-channel-stream-transport' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/playback-settings' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/sdp-extension' AND [method]='PUT' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'系统配置' WHERE [path]='/api/sysParam/edit' AND [method]='PUT' AND [api_group]<>N'系统配置';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/stream-probes/:streamId' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'仪表盘' WHERE [path]='/api/gb28181/sip/dashboard/snapshot' AND [method]='GET' AND [api_group]<>N'仪表盘';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/playback-settings' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'日志中心' WHERE [path]='/api/gb28181/logs/stream' AND [method]='GET' AND [api_group]<>N'日志中心';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients' AND [method]='GET' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients' AND [method]='POST' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/capabilities' AND [method]='GET' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id' AND [method]='GET' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id/scopes' AND [method]='PUT' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id/rotate-secret' AND [method]='POST' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id/enable' AND [method]='POST' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id/disable' AND [method]='POST' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id/revoke' AND [method]='POST' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id/audits' AND [method]='GET' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'OpenAPI 客户端' WHERE [path]='/api/gb28181/openapi-clients/:id/revocation-status' AND [method]='GET' AND [api_group]<>N'OpenAPI 客户端';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/stream-probes/operations/:operationId' AND [method]='GET' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/video-params' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/video-params' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/storage-cards' AND [method]='GET' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/enable' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'流媒体管理' WHERE [path]='/api/gb28181/zlm/nodes/:id/disable' AND [method]='POST' AND [api_group]<>N'流媒体管理';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/device-configs' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/device-configs' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'图像库' WHERE [path]='/api/gb28181/device-mgmt/snapshots/:id/content' AND [method]='GET' AND [api_group]<>N'图像库';
UPDATE [sys_api] SET [api_group]=N'设备管理' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/storage-cards/format' AND [method]='POST' AND [api_group]<>N'设备管理';
UPDATE [sys_api] SET [api_group]=N'图像库' WHERE [path]='/api/gb28181/device-mgmt/snapshots' AND [method]='GET' AND [api_group]<>N'图像库';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/target-track' AND [method]='GET' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'设备控制' WHERE [path]='/api/gb28181/device-mgmt/channel/:id/target-track' AND [method]='POST' AND [api_group]<>N'设备控制';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/channels/share' AND [method]='POST' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/channels/unshare' AND [method]='POST' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标级联' WHERE [path]='/api/gb28181/cascade/platforms/:id/reconnect' AND [method]='POST' AND [api_group]<>N'国标级联';
UPDATE [sys_api] SET [api_group]=N'国标服务配置' WHERE [path]='/api/gb28181/sip/service-config/default-channel-stream-transport' AND [method]='GET' AND [api_group]<>N'国标服务配置';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]=N'/api/gb28181/play/lifecycles' AND [method]=N'GET' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]=N'/api/gb28181/play/lifecycles/:lifecycleId' AND [method]=N'GET' AND [api_group]<>N'多屏播放';
UPDATE [sys_api] SET [api_group]=N'多屏播放' WHERE [path]=N'/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND [method]=N'POST' AND [api_group]<>N'多屏播放';
-- api-group-reroute:end

-- Playback lifecycle log baseline (kept in sync with 2026-09-21-play-lifecycle-log).
IF OBJECT_ID(N'gb_play_attempt', N'U') IS NULL CREATE TABLE gb_play_attempt (
  id BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY, correlation_id NVARCHAR(64) NOT NULL, user_id BIGINT NOT NULL,
  device_code NVARCHAR(20) NOT NULL, channel_code NVARCHAR(20) NOT NULL, node_id BIGINT NOT NULL CONSTRAINT df_play_attempt_node_lifecycle DEFAULT 0,
  reused BIT NOT NULL CONSTRAINT df_play_attempt_reused_lifecycle DEFAULT 0, outcome NVARCHAR(32) NOT NULL,
  failure_stage NVARCHAR(32) NOT NULL CONSTRAINT df_play_attempt_failure_stage_lifecycle DEFAULT N'',
  stream_id NVARCHAR(128) NOT NULL CONSTRAINT df_play_attempt_stream_lifecycle DEFAULT N'',
  ssrc NVARCHAR(32) NOT NULL CONSTRAINT df_play_attempt_ssrc_lifecycle DEFAULT N'',
  call_id NVARCHAR(128) NOT NULL CONSTRAINT df_play_attempt_call_lifecycle DEFAULT N'',
  cseq NVARCHAR(32) NOT NULL CONSTRAINT df_play_attempt_cseq_lifecycle DEFAULT N'',
  current_stage NVARCHAR(32) NOT NULL CONSTRAINT df_play_attempt_current_stage_lifecycle DEFAULT N'unknown',
  media_state NVARCHAR(32) NOT NULL CONSTRAINT df_play_attempt_media_state_lifecycle DEFAULT N'unknown',
  client_state NVARCHAR(32) NOT NULL CONSTRAINT df_play_attempt_client_state_lifecycle DEFAULT N'unknown',
  lifecycle_state NVARCHAR(32) NOT NULL CONSTRAINT df_play_attempt_lifecycle_state DEFAULT N'in_progress',
  reason_code NVARCHAR(64) NOT NULL CONSTRAINT df_play_attempt_reason_code_lifecycle DEFAULT N'',
  reason_message NVARCHAR(256) NOT NULL CONSTRAINT df_play_attempt_reason_message_lifecycle DEFAULT N'',
  client_first_frame_at DATETIME2(3) NULL, client_error_at DATETIME2(3) NULL,
  client_error_code NVARCHAR(64) NOT NULL CONSTRAINT df_play_attempt_client_error_lifecycle DEFAULT N'',
  last_event_at DATETIME2(3) NULL, started_at DATETIME2(3) NOT NULL, finished_at DATETIME2(3) NULL,
  created_at DATETIME2(3) NOT NULL, updated_at DATETIME2(3) NOT NULL,
  CONSTRAINT uk_play_attempt_correlation_lifecycle UNIQUE (correlation_id)
);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name='idx_play_attempt_user_started_lifecycle' AND object_id=OBJECT_ID('gb_play_attempt')) CREATE INDEX idx_play_attempt_user_started_lifecycle ON gb_play_attempt(user_id,started_at);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name='idx_play_attempt_device_started_lifecycle' AND object_id=OBJECT_ID('gb_play_attempt')) CREATE INDEX idx_play_attempt_device_started_lifecycle ON gb_play_attempt(device_code,started_at);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name='idx_play_attempt_outcome_started_lifecycle' AND object_id=OBJECT_ID('gb_play_attempt')) CREATE INDEX idx_play_attempt_outcome_started_lifecycle ON gb_play_attempt(outcome,started_at);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name='idx_play_attempt_lifecycle_started' AND object_id=OBJECT_ID('gb_play_attempt')) CREATE INDEX idx_play_attempt_lifecycle_started ON gb_play_attempt(lifecycle_state,started_at);
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name='idx_play_attempt_stream_node_lifecycle' AND object_id=OBJECT_ID('gb_play_attempt')) CREATE INDEX idx_play_attempt_stream_node_lifecycle ON gb_play_attempt(stream_id,node_id);

IF OBJECT_ID(N'gb_play_lifecycle_event', N'U') IS NULL
BEGIN
  CREATE TABLE gb_play_lifecycle_event (
    id BIGINT IDENTITY(1,1) NOT NULL PRIMARY KEY, event_id NVARCHAR(64) NOT NULL, lifecycle_id NVARCHAR(64) NOT NULL,
    sequence BIGINT NOT NULL, event_at DATETIME2(3) NOT NULL, elapsed_ms BIGINT NOT NULL CONSTRAINT df_play_lifecycle_elapsed_baseline DEFAULT 0,
    stage NVARCHAR(32) NOT NULL, event_name NVARCHAR(64) NOT NULL, fact_state NVARCHAR(32) NOT NULL, source NVARCHAR(32) NOT NULL,
    device_code NVARCHAR(20) NOT NULL, channel_code NVARCHAR(20) NOT NULL,
    stream_id NVARCHAR(128) NOT NULL CONSTRAINT df_play_lifecycle_stream_baseline DEFAULT N'',
    node_id BIGINT NOT NULL CONSTRAINT df_play_lifecycle_node_baseline DEFAULT 0,
    ssrc NVARCHAR(32) NOT NULL CONSTRAINT df_play_lifecycle_ssrc_baseline DEFAULT N'',
    reused BIT NOT NULL CONSTRAINT df_play_lifecycle_reused_baseline DEFAULT 0,
    call_id NVARCHAR(128) NOT NULL CONSTRAINT df_play_lifecycle_call_baseline DEFAULT N'',
    cseq NVARCHAR(32) NOT NULL CONSTRAINT df_play_lifecycle_cseq_baseline DEFAULT N'',
    reason_code NVARCHAR(64) NOT NULL CONSTRAINT df_play_lifecycle_reason_code_baseline DEFAULT N'',
    reason_message NVARCHAR(256) NOT NULL CONSTRAINT df_play_lifecycle_reason_message_baseline DEFAULT N'',
    metadata_json NVARCHAR(MAX) NULL, created_at DATETIME2(3) NOT NULL CONSTRAINT df_play_lifecycle_created_baseline DEFAULT SYSUTCDATETIME(),
    CONSTRAINT uk_play_lifecycle_event_id_baseline UNIQUE (event_id), CONSTRAINT uk_play_lifecycle_sequence_baseline UNIQUE (lifecycle_id,sequence)
  );
  CREATE INDEX idx_play_lifecycle_event_lifecycle_sequence_baseline ON gb_play_lifecycle_event(lifecycle_id,sequence);
  CREATE INDEX idx_play_lifecycle_event_at_baseline ON gb_play_lifecycle_event(event_at);
  CREATE INDEX idx_play_lifecycle_event_device_at_baseline ON gb_play_lifecycle_event(device_code,event_at);
  CREATE INDEX idx_play_lifecycle_event_stream_node_baseline ON gb_play_lifecycle_event(stream_id,node_id);
  CREATE INDEX idx_play_lifecycle_event_stage_baseline ON gb_play_lifecycle_event(stage,fact_state);
END;

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询播放日志',N'/api/gb28181/play/lifecycles',N'GET',N'播放日志',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/play/lifecycles' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'查询播放日志详情',N'/api/gb28181/play/lifecycles/:lifecycleId',N'GET',N'播放日志',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/play/lifecycles/:lifecycleId' AND method=N'GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT N'上报播放客户端事实',N'/api/gb28181/play/lifecycles/:lifecycleId/client-events',N'POST',N'播放日志',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path=N'/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND method=N'POST' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by) SELECT COALESCE((SELECT MIN(id) FROM sys_menu WHERE path=N'/media' AND type IN (1,2) AND deleted_at IS NULL),0),N'/gb28181/playback-log',N'gb28181-playback-log',N'gb28181/playback-log/index',N'播放日志',0,0,7,2,N'gb28181:play-log:view',N'lucide:FileClock',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE path=N'/gb28181/playback-log' AND deleted_at IS NULL);
INSERT INTO sys_role_menu(role_id,menu_id) SELECT 1,m.id FROM sys_menu m WHERE m.path=N'/gb28181/playback-log' AND m.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_role_menu x WHERE x.role_id=1 AND x.menu_id=m.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.path=N'/gb28181/playback-log' AND m.deleted_at IS NULL AND a.path IN (N'/api/gb28181/play/lifecycles',N'/api/gb28181/play/lifecycles/:lifecycleId') AND a.method=N'GET' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission=N'gb28181:play:start' AND m.type=3 AND m.deleted_at IS NULL AND a.path=N'/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND a.method=N'POST' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_casbin_rule(ptype,v0,v1,v2,v3,v4,v5) SELECT DISTINCT N'p',CONCAT(N'role_',rm.role_id),a.path,a.method,N'*',N'',N'' FROM sys_role_menu rm JOIN sys_menu m ON m.id=rm.menu_id JOIN sys_menu_api ma ON ma.menu_id=m.id JOIN sys_api a ON a.id=ma.api_id WHERE ((m.path=N'/gb28181/playback-log' AND a.method=N'GET') OR (m.permission=N'gb28181:play:start' AND m.type=3 AND a.method=N'POST')) AND a.path LIKE N'/api/gb28181/play/lifecycles%' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_casbin_rule p WHERE p.ptype=N'p' AND p.v0=CONCAT(N'role_',rm.role_id) AND p.v1=a.path AND p.v2=a.method AND p.v3=N'*');
UPDATE sys_api SET api_group=N'多屏播放' WHERE path=N'/api/gb28181/play/lifecycles' AND method=N'GET' AND api_group<>N'多屏播放';
UPDATE sys_api SET api_group=N'多屏播放' WHERE path=N'/api/gb28181/play/lifecycles/:lifecycleId' AND method=N'GET' AND api_group<>N'多屏播放';
UPDATE sys_api SET api_group=N'多屏播放' WHERE path=N'/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND method=N'POST' AND api_group<>N'多屏播放';
