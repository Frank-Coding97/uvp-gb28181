...
CREATE TABLE gb_sip_security_event (
 ...
 address_family NVARCHAR(8) NOT NULL, transport NVARCHAR(8) NOT NULL, method NVARCHAR(16) NOT NULL,
...
CREATE TABLE gb_sip_security_ban (
 ...
 score INT NOT NULL DEFAULT 0, created_at DATETIME2 NOT NULL, expires_at DATETIME2 NOT NULL,
 unbanned_at DATETIME2 NULL, unbanned_by NVARCHAR(64) NOT NULL DEFAULT '', origin NVARCHAR(16) NOT NULL,
 agent_state NVARCHAR(16) NOT NULL, decision_id NVARCHAR(64) NOT NULL UNIQUE, last_error NVARCHAR(512) NOT NULL DEFAULT '');
...
VALUES ('global','observe',60,100,65536,120,32,3,60,'100:600;250:3600;500:86400','',SYSUTCDATETIME());
