-- Cloud recording stop permission (PostgreSQL).
INSERT INTO sys_menu (parent_id,path,name,component,title,type,permission,hide,created_at,updated_at,created_by)
SELECT m.id,'','','','停止录像',3,'gb28181:recording:stop',1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1
...
SELECT '停止云端录像','/api/gb28181/cloud-recordings/active/:id/stop','POST','GB28181 云端录像控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1
