...
-- Media management menus and exact backend permission bindings (mysql, idempotent).
...
SELECT 0,'/media','Media','/gb28181/zlm/overview','','流媒体管理','lucide:Clapperboard',9,1,'',1,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `redirect`='/gb28181/zlm/overview',`title`='流媒体管理',`icon`='lucide:Clapperboard',`sort`=9,`updated_at`=NOW()
WHERE `path`='/media' AND `deleted_at` IS NULL;

UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='集群概览',`icon`='lucide:LayoutDashboard',`sort`=10,`updated_at`=NOW()
...
SELECT @media_menu_id,'/gb28181/zlm/overview','gb28181-zlm-overview','','gb28181/zlm/ClusterOverview','集群概览','lucide:LayoutDashboard',10,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='节点管理',`icon`='lucide:Server',`sort`=11,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/nodes' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/nodes','gb28181-zlm-nodes','','gb28181/zlm/NodeList','节点管理','lucide:Server',11,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='调度策略',`icon`='lucide:Workflow',`sort`=12,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/scheduler' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/scheduler','gb28181-zlm-scheduler-strategy','','gb28181/zlm/SchedulerStrategy','调度策略','lucide:Workflow',12,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='调度日志',`icon`='lucide:History',`sort`=13,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/scheduler/logs' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/scheduler/logs','gb28181-zlm-scheduler-log','','gb28181/zlm/SchedulerLog','调度日志','lucide:History',13,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='运行监控',`icon`='lucide:Activity',`sort`=20,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/runtime' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/runtime','gb28181-zlm-runtime','','gb28181/zlm/RuntimeOverview','运行监控','lucide:Activity',20,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='流媒体',`icon`='lucide:RadioTower',`sort`=21,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/streams' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/streams','gb28181-zlm-streams','','gb28181/zlm/StreamManagement','流媒体','lucide:RadioTower',21,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='会话管理',`icon`='lucide:Users',`sort`=22,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/sessions' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/sessions','gb28181-zlm-sessions','','gb28181/zlm/SessionManagement','会话管理','lucide:Users',22,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='拉流代理',`icon`='lucide:Network',`sort`=30,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/proxies' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/proxies','gb28181-zlm-proxies','','gb28181/zlm/ProxyManagement','拉流代理','lucide:Network',30,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='FFmpeg 源',`icon`='lucide:Clapperboard',`sort`=31,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/ffmpeg-sources' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/ffmpeg-sources','gb28181-zlm-ffmpeg-sources','','gb28181/zlm/FFmpegSources','FFmpeg 源','lucide:Clapperboard',31,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='RTP 服务',`icon`='lucide:Waypoints',`sort`=32,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/rtp-servers' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/rtp-servers','gb28181-zlm-rtp-servers','','gb28181/zlm/RTPServices','RTP 服务','lucide:Waypoints',32,2,'',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='录制管理',`icon`='lucide:Cloud',`sort`=40,`updated_at`=NOW()
WHERE `path`='/gb28181/cloud-recordings' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/cloud-recordings','gb28181-cloud-recordings','','gb28181/cloud-recordings/index','录制管理','lucide:Cloud',40,2,'gb28181:recording:view',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='录像计划',`icon`='lucide:CalendarClock',`sort`=41,`updated_at`=NOW()
WHERE `path`='/gb28181/recording-schedules' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/recording-schedules','gb28181-recording-schedules','','gb28181/recording-schedules/index','录像计划','lucide:CalendarClock',41,2,'gb28181:recording-plan:view',0,NOW(),NOW(),1
...
UPDATE `sys_menu` SET `parent_id`=@media_menu_id,`redirect`='',`title`='服务配置',`icon`='lucide:Settings2',`sort`=42,`updated_at`=NOW()
WHERE `path`='/gb28181/zlm/config' AND `deleted_at` IS NULL;
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`redirect`,`component`,`title`,`icon`,`sort`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT @media_menu_id,'/gb28181/zlm/config','gb28181-zlm-config','','gb28181/zlm/ServerConfig','服务配置','lucide:Settings2',42,2,'',0,NOW(),NOW(),1
...
SELECT p.`id`,'','','','管理节点',3,'gb28181:zlm:node:manage',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','踢除节点会话',3,'gb28181:zlm:node:kick',1,NOW(),NOW(),1 FROM `sys_menu` p
WHERE p.`path`='/gb28181/zlm/nodes' AND p.`deleted_at` IS NULL
AND NOT EXISTS (SELECT 1 FROM `sys_menu` WHERE `permission`='gb28181:zlm:node:kick' AND `deleted_at` IS NULL);

INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','切换调度策略',3,'gb28181:zlm:scheduler:manage',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','预览与截图',3,'gb28181:zlm:stream:preview',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','关闭流',3,'gb28181:zlm:stream:close',1,NOW(),NOW(),1 FROM `sys_menu` p
WHERE p.`path`='/gb28181/zlm/streams' AND p.`deleted_at` IS NULL
AND NOT EXISTS (SELECT 1 FROM `sys_menu` WHERE `permission`='gb28181:zlm:stream:close' AND `deleted_at` IS NULL);

INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','强制关闭流',3,'gb28181:zlm:stream:force-close',1,NOW(),NOW(),1 FROM `sys_menu` p
WHERE p.`path`='/gb28181/zlm/streams' AND p.`deleted_at` IS NULL
AND NOT EXISTS (SELECT 1 FROM `sys_menu` WHERE `permission`='gb28181:zlm:stream:force-close' AND `deleted_at` IS NULL);

INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','踢除会话',3,'gb28181:zlm:session:kick',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','管理代理',3,'gb28181:zlm:proxy:manage',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','管理 FFmpeg 源',3,'gb28181:zlm:ffmpeg:manage',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','管理 RTP 服务',3,'gb28181:zlm:rtp:manage',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','强制关闭 RTP 服务',3,'gb28181:zlm:rtp:force-close',1,NOW(),NOW(),1 FROM `sys_menu` p
WHERE p.`path`='/gb28181/zlm/rtp-servers' AND p.`deleted_at` IS NULL
AND NOT EXISTS (SELECT 1 FROM `sys_menu` WHERE `permission`='gb28181:zlm:rtp:force-close' AND `deleted_at` IS NULL);

INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','手工录制控制',3,'gb28181:recording:control',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','强制停止录制',3,'gb28181:recording:force-stop',1,NOW(),NOW(),1 FROM `sys_menu` p
WHERE p.`path`='/gb28181/cloud-recordings' AND p.`deleted_at` IS NULL
AND NOT EXISTS (SELECT 1 FROM `sys_menu` WHERE `permission`='gb28181:recording:force-stop' AND `deleted_at` IS NULL);

INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','更新服务配置',3,'gb28181:zlm:config:update',1,NOW(),NOW(),1 FROM `sys_menu` p
...
INSERT INTO `sys_menu` (`parent_id`,`path`,`name`,`component`,`title`,`type`,`permission`,`hide`,`created_at`,`updated_at`,`created_by`)
SELECT p.`id`,'','','','重启媒体服务',3,'gb28181:zlm:restart',1,NOW(),NOW(),1 FROM `sys_menu` p
WHERE p.`path`='/gb28181/zlm/config' AND p.`deleted_at` IS NULL
...
SELECT v.`title`,v.`path`,v.`method`,'GB28181 媒体管理',NOW(),NOW(),1 FROM (
...
SELECT DISTINCT 'p',CONCAT('role_',rm.`role_id`),a.`path`,a.`method`,'*','','' FROM `sys_role_menu` rm
