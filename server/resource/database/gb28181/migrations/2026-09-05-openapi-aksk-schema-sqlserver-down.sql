...
IF COL_LENGTH(N'dbo.meta_node', N'runtime_identity_status') IS NOT NULL ALTER TABLE dbo.meta_node DROP COLUMN runtime_identity_status;
...
IF COL_LENGTH(N'dbo.meta_node', N'runtime_confirmed_revision') IS NOT NULL ALTER TABLE dbo.meta_node DROP COLUMN runtime_confirmed_revision;
...
IF COL_LENGTH(N'dbo.meta_node', N'runtime_protocol_version') IS NOT NULL ALTER TABLE dbo.meta_node DROP COLUMN runtime_protocol_version;
...
IF COL_LENGTH(N'dbo.meta_node', N'runtime_epoch') IS NOT NULL ALTER TABLE dbo.meta_node DROP COLUMN runtime_epoch;
...
IF COL_LENGTH(N'dbo.gb_device', N'access_epoch') IS NOT NULL ALTER TABLE dbo.gb_device DROP COLUMN access_epoch;
