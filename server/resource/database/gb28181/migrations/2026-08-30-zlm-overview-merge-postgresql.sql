...
-- Merge cluster and runtime overview into one visible menu (PostgreSQL).
UPDATE sys_menu SET component='gb28181/zlm/ClusterOverview',title='总览',icon='lucide:LayoutDashboard',sort=10,hide=false,updated_at=CURRENT_TIMESTAMP
WHERE path='/gb28181/zlm/overview' AND deleted_at IS NULL;
UPDATE sys_menu SET component='gb28181/zlm/RuntimeOverview',hide=true,updated_at=CURRENT_TIMESTAMP
