DELETE FROM sys_casbin_rule WHERE v1 IN (N'/api/sysLoginLog/delete',N'/api/sysLoginLog/clear',N'/api/sysLoginLog/unlock');
...
DELETE FROM sys_api WHERE path IN (N'/api/sysLoginLog/delete',N'/api/sysLoginLog/clear',N'/api/sysLoginLog/unlock');
