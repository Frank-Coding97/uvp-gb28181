...
INSERT INTO `sys_api` (`id`,`title`,`path`,`method`,`api_group`,`created_at`,`updated_at`,`deleted_at`,`created_by`) VALUES
(222,'创建自定义分组','/api/gb28181/device-mgmt/custom-groups','POST','GB28181 设备管理',NOW(),NOW(),NULL,1),
(223,'修改自定义分组','/api/gb28181/device-mgmt/custom-groups/:id','PATCH','GB28181 设备管理',NOW(),NOW(),NULL,1),
(224,'移动自定义分组','/api/gb28181/device-mgmt/custom-groups/:id/move','POST','GB28181 设备管理',NOW(),NOW(),NULL,1),
(225,'删除自定义分组','/api/gb28181/device-mgmt/custom-groups/:id','DELETE','GB28181 设备管理',NOW(),NOW(),NULL,1),
(226,'添加分组设备','/api/gb28181/device-mgmt/custom-groups/:id/devices','POST','GB28181 设备管理',NOW(),NOW(),NULL,1),
(227,'移除分组设备','/api/gb28181/device-mgmt/custom-groups/:id/devices/remove','POST','GB28181 设备管理',NOW(),NOW(),NULL,1);
INSERT INTO `sys_menu` (`id`,`parent_id`,`path`,`name`,`component`,`title`,`hide`,`type`,`permission`,`created_at`,`updated_at`,`created_by`) VALUES
(140361,140355,'','','','管理自定义分组',1,3,'gb28181:device-group:manage',NOW(),NOW(),1);
...
INSERT INTO `sys_api` (`id`,`title`,`path`,`method`,`api_group`,`created_at`,`updated_at`,`deleted_at`,`created_by`) VALUES
(228,'查询播放方案','/api/gb28181/playback-schemes','GET','GB28181 多屏播放',NOW(),NOW(),NULL,1),
(229,'查看播放方案','/api/gb28181/playback-schemes/:id','GET','GB28181 多屏播放',NOW(),NOW(),NULL,1),
(230,'创建播放方案','/api/gb28181/playback-schemes','POST','GB28181 多屏播放',NOW(),NOW(),NULL,1),
(231,'重命名播放方案','/api/gb28181/playback-schemes/:id','PATCH','GB28181 多屏播放',NOW(),NOW(),NULL,1),
(232,'覆盖播放方案','/api/gb28181/playback-schemes/:id/layout','PUT','GB28181 多屏播放',NOW(),NOW(),NULL,1),
(233,'删除播放方案','/api/gb28181/playback-schemes/:id','DELETE','GB28181 多屏播放',NOW(),NOW(),NULL,1);
INSERT INTO `sys_menu` (`id`,`parent_id`,`path`,`name`,`component`,`title`,`hide`,`type`,`permission`,`created_at`,`updated_at`,`created_by`) VALUES
(140362,140355,'','','','管理播放方案',1,3,'gb28181:playback-scheme:manage',NOW(),NOW(),1);
...
-- GB28181 cascade API/menu/Casbin seed for fresh MySQL installs.
INSERT INTO `sys_api` (`id`,`title`,`path`,`method`,`api_group`,`created_at`,`updated_at`,`deleted_at`,`created_by`) VALUES
(234,'查看级联平台列表','/api/gb28181/cascade/platforms','GET','GB28181 国标级联',NOW(),NOW(),NULL,1),(235,'创建级联平台','/api/gb28181/cascade/platforms','POST','GB28181 国标级联',NOW(),NOW(),NULL,1),(236,'查看级联平台','/api/gb28181/cascade/platforms/:id','GET','GB28181 国标级联',NOW(),NOW(),NULL,1),(237,'修改级联平台','/api/gb28181/cascade/platforms/:id','PUT','GB28181 国标级联',NOW(),NOW(),NULL,1),(238,'删除级联平台','/api/gb28181/cascade/platforms/:id','DELETE','GB28181 国标级联',NOW(),NOW(),NULL,1),(239,'启停级联平台','/api/gb28181/cascade/platforms/:id/enabled','PUT','GB28181 国标级联',NOW(),NOW(),NULL,1),(240,'启用级联平台','/api/gb28181/cascade/platforms/:id/enable','POST','GB28181 国标级联',NOW(),NOW(),NULL,1),(241,'停用级联平台','/api/gb28181/cascade/platforms/:id/disable','POST','GB28181 国标级联',NOW(),NOW(),NULL,1),(242,'重连级联平台','/api/gb28181/cascade/platforms/:id/reconnect','POST','GB28181 国标级联',NOW(),NOW(),NULL,1),(243,'查看级联共享','/api/gb28181/cascade/platforms/:id/shares','GET','GB28181 国标级联',NOW(),NOW(),NULL,1),(244,'更新级联共享','/api/gb28181/cascade/platforms/:id/shares','PUT','GB28181 国标级联',NOW(),NOW(),NULL,1),(245,'共享级联通道','/api/gb28181/cascade/platforms/:id/channels/share','POST','GB28181 国标级联',NOW(),NOW(),NULL,1),(246,'取消级联通道共享','/api/gb28181/cascade/platforms/:id/channels/unshare','POST','GB28181 国标级联',NOW(),NOW(),NULL,1);
...
(140370,0,'/gb28181/cascade','gb28181-cascade','gb28181/cascade/index','国标级联',0,0,13,2,'','lucide:GitBranch',NOW(),NOW(),1);
INSERT INTO `sys_menu` (`id`,`parent_id`,`path`,`name`,`component`,`title`,`hide`,`type`,`permission`,`created_at`,`updated_at`,`created_by`) VALUES
(140363,140370,'','','','查看国标级联',1,3,'gb28181:cascade:view',NOW(),NOW(),1),(140364,140370,'','','','管理国标级联',1,3,'gb28181:cascade:manage',NOW(),NOW(),1),(140365,140370,'','','','启停国标级联',1,3,'gb28181:cascade:enable',NOW(),NOW(),1),(140366,140370,'','','','共享国标级联资源',1,3,'gb28181:cascade:share',NOW(),NOW(),1),(140367,140370,'','','','重连国标级联',1,3,'gb28181:cascade:reconnect',NOW(),NOW(),1);
