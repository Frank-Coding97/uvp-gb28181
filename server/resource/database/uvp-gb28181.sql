...
INSERT INTO `sys_menu` (`id`,`parent_id`,`path`,`name`,`component`,`title`,`hide`,`type`,`permission`,`created_at`,`updated_at`,`created_by`) VALUES
(140363,140355,'','','','查看国标级联',1,3,'gb28181:cascade:view',NOW(),NOW(),1),(140364,140355,'','','','管理国标级联',1,3,'gb28181:cascade:manage',NOW(),NOW(),1),(140365,140355,'','','','启停国标级联',1,3,'gb28181:cascade:enable',NOW(),NOW(),1),(140366,140355,'','','','共享国标级联资源',1,3,'gb28181:cascade:share',NOW(),NOW(),1),(140367,140355,'','','','重连国标级联',1,3,'gb28181:cascade:reconnect',NOW(),NOW(),1);
INSERT INTO `sys_role_menu` (`role_id`,`menu_id`) VALUES (1,140363),(1,140364),(1,140365),(1,140366),(1,140367);
