-- SQLite standalone baseline generated from release source fdcb63da.
...
CREATE TABLE IF NOT EXISTS "gb_work_order_form_history" (
  ...
  "updated_at" DATETIME NOT NULL,
  CHECK ("id" IS NULL OR (typeof("id") = 'integer')),
  CHECK ("field_key" IS NULL OR length("field_key") <= 64),
  CHECK ("value" IS NULL OR length("value") <= 256),
  CHECK ("use_count" IS NULL OR (typeof("use_count") = 'integer' AND "use_count" BETWEEN -2147483648 AND 2147483647))
);
CREATE UNIQUE INDEX IF NOT EXISTS "uk_gb_work_order_form_history_field_value" ON "gb_work_order_form_history" ("field_key", "value");
CREATE INDEX IF NOT EXISTS "idx_gb_work_order_form_history_field_used" ON "gb_work_order_form_history" ("field_key", "last_used_at");
CREATE INDEX IF NOT EXISTS "idx_gb_work_order_form_history_field_count" ON "gb_work_order_form_history" ("field_key", "use_count");
...
WHERE m."permission" IN ('gb28181:work-recording:start','gb28181:work-recording:stop','gb28181:work-recording:form') AND m."deleted_at" IS NULL AND a."deleted_at" IS NULL
  AND NOT EXISTS (SELECT 1 FROM "sys_casbin_rule" c WHERE c."ptype"='p' AND c."v0"=('role_' || rm."role_id") AND c."v1"=a."path" AND c."v2"=a."method" AND c."v3"='*');
INSERT INTO "sys_menu" ("parent_id","path","name","component","title","hide","disable","sort","type","permission","icon","created_at","updated_at","created_by")
SELECT 0,'/gb28181/work-orders','gb28181-work-orders','gb28181/work-orders/index','作业单',0,0,14,2,'','lucide:ClipboardList','2026-09-07 00:00:00','2026-09-07 00:00:00',1
WHERE NOT EXISTS (SELECT 1 FROM "sys_menu" WHERE "path"='/gb28181/work-orders' AND "deleted_at" IS NULL);
INSERT INTO "sys_menu" ("parent_id","path","name","component","title","hide","disable","sort","type","permission","icon","created_at","updated_at","created_by")
SELECT COALESCE((SELECT MIN("id") FROM "sys_menu" WHERE "path"='/gb28181/work-orders' AND "type"=2 AND "deleted_at" IS NULL),0),'','Permission_gb28181_work_order_create','','新建作业单',1,0,1,3,'gb28181:work-order:create','','2026-09-07 00:00:00','2026-09-07 00:00:00',1
WHERE NOT EXISTS (SELECT 1 FROM "sys_menu" WHERE "permission"='gb28181:work-order:create' AND "deleted_at" IS NULL);
INSERT INTO "sys_menu" ("parent_id","path","name","component","title","hide","disable","sort","type","permission","icon","created_at","updated_at","created_by")
SELECT COALESCE((SELECT MIN("id") FROM "sys_menu" WHERE "path"='/gb28181/work-orders' AND "type"=2 AND "deleted_at" IS NULL),0),'','Permission_gb28181_work_order_stop','','结束作业单录制',1,0,2,3,'gb28181:work-order:stop','','2026-09-07 00:00:00','2026-09-07 00:00:00',1
WHERE NOT EXISTS (SELECT 1 FROM "sys_menu" WHERE "permission"='gb28181:work-order:stop' AND "deleted_at" IS NULL);
INSERT INTO "sys_menu" ("parent_id","path","name","component","title","hide","disable","sort","type","permission","icon","created_at","updated_at","created_by")
SELECT COALESCE((SELECT MIN("id") FROM "sys_menu" WHERE "path"='/gb28181/work-orders' AND "type"=2 AND "deleted_at" IS NULL),0),'','Permission_gb28181_work_order_view','','查看作业单',1,0,3,3,'gb28181:work-order:view','','2026-09-07 00:00:00','2026-09-07 00:00:00',1
...
WHERE m."deleted_at" IS NULL
  ...
  AND NOT EXISTS (SELECT 1 FROM "sys_role_menu" x WHERE x."role_id"=1 AND x."menu_id"=m."id");
INSERT INTO "sys_api" ("title","path","method","api_group","created_at","updated_at","created_by")
SELECT s.title,s.path,s.method,'GB28181 作业单','2026-09-07 00:00:00','2026-09-07 00:00:00',1 FROM (
...
UPDATE "sys_menu" SET "deleted_at"='2026-09-07 00:00:00', "updated_at"='2026-09-07 00:00:00'
WHERE "permission" IN ('gb28181:work-recording:start','gb28181:work-recording:stop','gb28181:work-recording:form')
  AND "deleted_at" IS NULL;
UPDATE "sys_api" SET "deleted_at"='2026-09-07 00:00:00', "updated_at"='2026-09-07 00:00:00'
WHERE "path" LIKE '/api/gb28181/work-recordings%'
  AND "deleted_at" IS NULL;
INSERT INTO "sys_menu" ("parent_id","path","name","component","title","hide","disable","sort","type","permission","icon","created_at","updated_at","created_by")
SELECT COALESCE((SELECT MIN("id") FROM "sys_menu" WHERE "path"='/gb28181/work-orders' AND "type"=2 AND "deleted_at" IS NULL),0),'','Permission_gb28181_work_order_delete','','删除作业单',1,0,4,3,'gb28181:work-order:delete','','2026-09-07 00:00:00','2026-09-07 00:00:00',1
...
WHERE m."permission"='gb28181:work-order:delete'
  ...
  AND NOT EXISTS (SELECT 1 FROM "sys_casbin_rule" c WHERE c."ptype"='p' AND c."v0"=('role_' || rm."role_id") AND c."v1"=a."path" AND c."v2"=a."method" AND c."v3"='*');
INSERT INTO "sys_api" ("title","path","method","api_group","created_at","updated_at","created_by")
SELECT '作业单表单历史值','/api/gb28181/work-orders/form-history','GET','GB28181 作业单','2026-09-07 00:00:00','2026-09-07 00:00:00',1
