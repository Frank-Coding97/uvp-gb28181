...
DO $$ BEGIN IF to_regclass('public.gb_channel') IS NOT NULL THEN ALTER TABLE gb_channel ADD COLUMN IF NOT EXISTS position_source VARCHAR(16) NOT NULL DEFAULT ''; END IF; END $$;
DO $$ BEGIN IF to_regclass('public.gb_channel') IS NOT NULL THEN ALTER TABLE gb_channel ADD COLUMN IF NOT EXISTS position_updated_at TIMESTAMP(3); END IF; END $$;
...
CREATE TABLE IF NOT EXISTS gb_device_control_state (
    ...
    online_state VARCHAR(8),
    selftest_state VARCHAR(16),
    encode_state VARCHAR(8),
    device_time TIMESTAMP(3),
    alarm_input_count INTEGER,
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取全局订阅项目','/api/gb28181/sip/service-config/global-subscriptions','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/global-subscriptions' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取忽略通道离线异常通知配置','/api/gb28181/sip/service-config/ignore-channel-offline-status-notify','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/ignore-channel-offline-status-notify' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取收到心跳恢复设备上线配置','/api/gb28181/sip/service-config/online-on-heartbeat','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/online-on-heartbeat' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取播放鉴权配置','/api/gb28181/sip/service-config/play-auth','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/play-auth' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取预分配模式','/api/gb28181/sip/service-config/preallocation-mode','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/preallocation-mode' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取云台默认速度配置','/api/gb28181/sip/service-config/ptz-default-speed','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/ptz-default-speed' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取报警消息存储配置','/api/gb28181/sip/service-config/save-alarm-messages','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/save-alarm-messages' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取 SIP 命令超时时间','/api/gb28181/sip/service-config/sip-command-timeout','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/sip-command-timeout' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取 SIP 日志配置','/api/gb28181/sip/service-config/sip-log','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/sip-log' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取设备上线同步通道配置','/api/gb28181/sip/service-config/sync-channels-on-online','GET','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/sync-channels-on-online' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取本机网络接口','/api/gb28181/sip/setup/network-interfaces','GET','SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/setup/network-interfaces' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '读取 SIP 配置状态','/api/gb28181/sip/setup/status','GET','SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/setup/status' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询探针检测结果','/api/gb28181/stream-probes/operations/:operationId','GET','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/stream-probes/operations/:operationId' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查看媒体节点详情','/api/gb28181/zlm/nodes/:id','GET','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询媒体服务重启状态','/api/gb28181/zlm/nodes/:id/restart','GET','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/restart' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查看媒体流详情','/api/gb28181/zlm/nodes/:id/streams/detail','GET','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/detail' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '截取媒体流快照','/api/gb28181/zlm/nodes/:id/streams/snapshot','GET','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/snapshot' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询媒体流观看者','/api/gb28181/zlm/nodes/:id/streams/viewers','GET','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/viewers' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询单条数据','/api/plugins/example/:id','GET','插件示例',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/plugins/example' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/plugins/example/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '下载文件','/api/sysAffix/download/:id','GET','文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysAffix/download/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '根据ID获取API信息','/api/sysApi/:id','GET','接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/api' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysApi/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT 'API列表','/api/sysApi/list','GET','接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysApi/list' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '获取部门列表','/api/sysDepartment/getDivision','GET','部门管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDepartment/getDivision' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '根据字典编码获取字典项列表','/api/sysDictItem/getByDictCode/:dictCode','GET','字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDictItem/getByDictCode/:dictCode' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '字典项管理','/api/sysDictItem/getByDictId/:dictId','GET','字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDictItem/getByDictId/:dictId' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '获取代码生成配置详情','/api/sysGen/:id','GET','代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysGen/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查看定时任务日志','/api/sysJobResults/list','GET','日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysJobResults/list' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '定时任务获取数据','/api/sysJobs/:id','GET','定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysJobs/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查看登录日志详情','/api/sysLoginLog/:id','GET','日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/login-log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysLoginLog/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '根据菜单ID获取API的ID集合','/api/sysMenu/apis/:id','GET','菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysMenu/apis/:id' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '导出菜单','/api/sysMenu/export','GET','菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysMenu/export' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '获取完整菜单列表','/api/sysMenu/getMenuList','GET','菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysMenu/getMenuList' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '日志导出','/api/sysOperationLog/export','GET','日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysOperationLog/export' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '根据角色ID获取角色菜单权限','/api/sysRole/getUserPermission/:roleId','GET','角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysRole/getUserPermission/:roleId' AND method='GET' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '编辑通道参数','/api/gb28181/device-mgmt/channel/:id','PATCH','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '切换通道云端录制','/api/gb28181/device-mgmt/channel/:id/cloud-recording','PATCH','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/cloud-recording' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '云台归位点更新','/api/gb28181/device-mgmt/channel/:id/ptz/home-position','PATCH','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz/home-position' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改通道传输模式','/api/gb28181/device-mgmt/channel/:id/stream-transport','PATCH','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/stream-transport' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改自定义分组','/api/gb28181/device-mgmt/custom-groups/:id','PATCH','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/custom-groups/:id' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新设备订阅','/api/gb28181/device-mgmt/device/:id/subscriptions/:kind','PATCH','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/device/:id/subscriptions/:kind' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '编辑设备','/api/gb28181/device/:deviceId','PATCH','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device/:deviceId' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '重命名播放方案','/api/gb28181/playback-schemes/:id','PATCH','多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/playback-schemes/:id' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '启停录像计划','/api/gb28181/recording-plans/:id/status','PATCH','录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/recording-plans/:id/status' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '切换通道录像模式','/api/gb28181/recording-plans/channels/:channelId/recording-mode','PATCH','录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/recording-plans/channels/:channelId/recording-mode' AND method='PATCH' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '生成代码文件','/api/codegen/generate','POST','代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/codegen/generate' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '生成菜单','/api/codegen/insertmenuandapi','POST','代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/codegen/insertmenuandapi' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '批量物理删除告警','/api/gb28181/alarms/batch-delete','POST','告警管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/alarm-management' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/alarms/batch-delete' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '清空全部告警','/api/gb28181/alarms/clear-all','POST','告警管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/alarm-management' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/alarms/clear-all' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '创建级联平台','/api/gb28181/cascade/platforms','POST','国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cascade/platforms' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '启用级联平台','/api/gb28181/cascade/platforms/:id/enable','POST','国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cascade/platforms/:id/enable' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '重连国标级联','/api/gb28181/cascade/platforms/:id/reconnect','POST','国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cascade/platforms/:id/reconnect' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新建通道收藏组','/api/gb28181/channel-favorite-groups','POST','多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/channel-favorite-groups' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '追加通道收藏','/api/gb28181/channel-favorite-groups/:id/channels','POST','多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/channel-favorite-groups/:id/channels' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '停止录像','/api/gb28181/cloud-recordings/active/:id/stop','POST','云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cloud-recordings/active/:id/stop' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '创建云端录像下载','/api/gb28181/cloud-recordings/files/:id/downloads','POST','云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cloud-recordings/files/:id/downloads' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '批量删除云端录像','/api/gb28181/cloud-recordings/files/batch-delete','POST','云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cloud-recordings/files/batch-delete' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '触发录像对账','/api/gb28181/cloud-recordings/reconciliations','POST','云端录像',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cloud-recordings/reconciliations' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '设备复合控制（关键帧、录制、守望、告警、拖拽变焦等）','/api/gb28181/device-mgmt/channel/:id/device-control','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/device-control' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '设备录像下载','/api/gb28181/device-mgmt/channel/:id/download-sessions','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-record-playback/:channelId' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/download-sessions' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '创建回放会话','/api/gb28181/device-mgmt/channel/:id/playback-sessions','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-record-playback/:channelId' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/playback-sessions' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '控制回放（暂停/续播/倍速）','/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId/actions','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-record-playback/:channelId' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/playback-sessions/:sessionId/actions' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '云台基础控制','/api/gb28181/device-mgmt/channel/:id/ptz','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '下发巡航指令','/api/gb28181/device-mgmt/channel/:id/ptz/cruise','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz/cruise' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '保存巡航轨迹','/api/gb28181/device-mgmt/channel/:id/ptz/cruise/tracks','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz/cruise/tracks' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '云台扩展控制','/api/gb28181/device-mgmt/channel/:id/ptz/extended','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz/extended' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '云台精准控制','/api/gb28181/device-mgmt/channel/:id/ptz/precise','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz/precise' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '保存预置位','/api/gb28181/device-mgmt/channel/:id/ptz/presets','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz/presets' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '调用预置位','/api/gb28181/device-mgmt/channel/:id/ptz/presets/:presetId/call','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/ptz/presets/:presetId/call' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询设备录像','/api/gb28181/device-mgmt/channel/:id/record-query','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/record-query' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '创建抓拍会话','/api/gb28181/device-mgmt/channel/:id/snapshot-sessions','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/snapshot-sessions' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '创建对讲会话','/api/gb28181/device-mgmt/channel/:id/talk-sessions','POST','设备控制',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/:id/talk-sessions' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '批量删除通道','/api/gb28181/device-mgmt/channel/batch-delete','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/channel/batch-delete' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '创建自定义分组','/api/gb28181/device-mgmt/custom-groups','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/custom-groups' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '添加分组设备','/api/gb28181/device-mgmt/custom-groups/:id/devices','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/custom-groups/:id/devices' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '移除分组设备','/api/gb28181/device-mgmt/custom-groups/:id/devices/remove','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/custom-groups/:id/devices/remove' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '移动自定义分组','/api/gb28181/device-mgmt/custom-groups/:id/move','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/custom-groups/:id/move' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新建设备','/api/gb28181/device-mgmt/device','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/device' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '刷新设备目录（下发 SIP 目录查询）','/api/gb28181/device-mgmt/device/:id/catalog/refresh','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/device/:id/catalog/refresh' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '升级设备','/api/gb28181/device-mgmt/device/:id/firmware-upgrade','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/device/:id/firmware-upgrade' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '重启设备','/api/gb28181/device-mgmt/device/:id/reboot','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/device/:id/reboot' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '续订设备订阅','/api/gb28181/device-mgmt/device/:id/subscriptions/:kind/renew','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/device/:id/subscriptions/:kind/renew' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '批量删除设备','/api/gb28181/device-mgmt/device/batch-delete','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/device/batch-delete' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '调整设备归属','/api/gb28181/device-mgmt/permission-workbench/assignments','POST','设备权限工作台',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-assignment' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/permission-workbench/assignments' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '整部门调整设备归属','/api/gb28181/device-mgmt/permission-workbench/assignments/departments','POST','设备权限工作台',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-assignment' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/permission-workbench/assignments/departments' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '解析工作台设备','/api/gb28181/device-mgmt/permission-workbench/devices/resolve','POST','设备权限工作台',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-assignment' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/permission-workbench/devices/resolve' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '应用设备共享授权','/api/gb28181/device-mgmt/permission-workbench/grants/apply','POST','设备权限工作台',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-assignment' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/permission-workbench/grants/apply' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询设备共享授权','/api/gb28181/device-mgmt/permission-workbench/grants/query','POST','设备权限工作台',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-assignment' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-mgmt/permission-workbench/grants/query' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '强退观看连接','/api/gb28181/device-traffic/viewers/kick','POST','设备管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/device-traffic/viewers/kick' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '发起实时点播','/api/gb28181/play/:deviceId/:channelId','POST','多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/play/:deviceId/:channelId' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '申请固定播放地址授权','/api/gb28181/play/:deviceId/:channelId/authorization','POST','多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/device-mgmt/index' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/play/:deviceId/:channelId/authorization' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '创建播放方案','/api/gb28181/playback-schemes','POST','多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/playback-schemes' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新建录像计划','/api/gb28181/recording-plans','POST','录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/recording-plans' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '提交录像计划分配','/api/gb28181/recording-plans/:id/assignments','POST','录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/recording-plans/:id/assignments' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增访问规则（黑白名单）','/api/gb28181/security/access-rules','POST','国标接入安全',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/security-preview' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/security/access-rules' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '解除自动封禁','/api/gb28181/security/bans/:id/unban','POST','国标接入安全',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/security-preview' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/security/bans/:id/unban' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '生成设备接入二维码','/api/gb28181/sip/qr/token','POST','SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL OR (SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/platform' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/qr/token' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '暂缓 SIP 配置','/api/gb28181/sip/setup/skip','POST','SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/setup/skip' AND method='POST' AND deleted_at IS NULL);
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增媒体节点','/api/gb28181/zlm/nodes','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '激活媒体节点','/api/gb28181/zlm/nodes/:id/activate','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/activate' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '测试媒体节点连接','/api/gb28181/zlm/nodes/:id/config/test-connection','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/config/test-connection' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '停用媒体节点','/api/gb28181/zlm/nodes/:id/disable','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/disable' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '启用媒体节点','/api/gb28181/zlm/nodes/:id/enable','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/enable' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增 FFmpeg 源','/api/gb28181/zlm/nodes/:id/ffmpeg-sources','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/ffmpeg-sources' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT 'FFmpeg 源预检','/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/ffmpeg-sources/:key/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '踢除节点上的全部会话','/api/gb28181/zlm/nodes/:id/kick','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/kick' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '媒体节点维护','/api/gb28181/zlm/nodes/:id/maintenance','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/maintenance' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增拉流代理','/api/gb28181/zlm/nodes/:id/proxies/pull','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/proxies/pull' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '拉流代理预检','/api/gb28181/zlm/nodes/:id/proxies/pull/:key/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/proxies/pull/:key/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增推流代理','/api/gb28181/zlm/nodes/:id/proxies/push','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/proxies/push' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '推流代理预检','/api/gb28181/zlm/nodes/:id/proxies/push/:key/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/proxies/push/:key/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '强制停止录制','/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '强制停止录制预检','/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/recordings/runtime/force-stop/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '开始录制','/api/gb28181/zlm/nodes/:id/recordings/runtime/start','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/recordings/runtime/start' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '开始录制预检','/api/gb28181/zlm/nodes/:id/recordings/runtime/start/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/recordings/runtime/start/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '停止录制','/api/gb28181/zlm/nodes/:id/recordings/runtime/stop','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/recordings/runtime/stop' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '停止录制预检','/api/gb28181/zlm/nodes/:id/recordings/runtime/stop/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cloud-recordings' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/recordings/runtime/stop/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '重启媒体服务','/api/gb28181/zlm/nodes/:id/restart','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/restart' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增 RTP 服务','/api/gb28181/zlm/nodes/:id/rtp-servers','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/rtp-servers' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '关闭 RTP 服务','/api/gb28181/zlm/nodes/:id/rtp-servers/close','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/rtp-servers/close' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '关闭 RTP 服务预检','/api/gb28181/zlm/nodes/:id/rtp-servers/close/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/rtp-servers/close/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '强制关闭 RTP 服务','/api/gb28181/zlm/nodes/:id/rtp-servers/force-close','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/ingress' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/rtp-servers/force-close' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '踢除指定播放会话','/api/gb28181/zlm/nodes/:id/sessions/kick','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/sessions/kick' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '关闭媒体流','/api/gb28181/zlm/nodes/:id/streams/close','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/close' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '批量关闭媒体流','/api/gb28181/zlm/nodes/:id/streams/close/batch','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/close/batch' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '批量关闭媒体流预检','/api/gb28181/zlm/nodes/:id/streams/close/batch/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/close/batch/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '关闭媒体流预检','/api/gb28181/zlm/nodes/:id/streams/close/preflight','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/close/preflight' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '强制关闭媒体流','/api/gb28181/zlm/nodes/:id/streams/force-close','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/force-close' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '发放播放授权','/api/gb28181/zlm/nodes/:id/streams/playback-grant','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/monitoring' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/streams/playback-grant' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '探测媒体节点','/api/gb28181/zlm/nodes/probe','POST','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/probe' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增插件示例','/api/plugins/example/add','POST','插件示例',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/plugins/example' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/plugins/example/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '导出插件','/api/pluginsmanager/export','POST','插件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/pluginsmanager' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/pluginsmanager/export' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '导入插件','/api/pluginsmanager/import','POST','插件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/pluginsmanager' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/pluginsmanager/import' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '分片上传初始化','/api/sysAffix/chunk/init','POST','文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysAffix/chunk/init' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '分片上传合并分片','/api/sysAffix/chunk/merge','POST','文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysAffix/chunk/merge' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '分片上传上传分片','/api/sysAffix/chunk/upload','POST','文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysAffix/chunk/upload' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '上传文件','/api/sysAffix/upload','POST','文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysAffix/upload' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增API','/api/sysApi/add','POST','接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/api' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysApi/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增部门','/api/sysDepartment/add','POST','部门管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/division' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDepartment/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增字典','/api/sysDict/add','POST','字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDict/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增字典项','/api/sysDictItem/add','POST','字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDictItem/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT ' 批量创建代码生成配置','/api/sysGen/batchInsert','POST','代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysGen/batchInsert' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '定时任务新增','/api/sysJobs/add','POST','定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysJobs/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '执行一次','/api/sysJobs/executeNow','POST','定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysJobs/executeNow' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '清空登录日志','/api/sysLoginLog/clear','POST','日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/login-log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysLoginLog/clear' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '解锁登录账号','/api/sysLoginLog/unlock','POST','日志中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/login-log' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysLoginLog/unlock' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增菜单','/api/sysMenu/add','POST','菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysMenu/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '导入','/api/sysMenu/import','POST','菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysMenu/import' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '设置菜单API权限','/api/sysMenu/setApis','POST','菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysMenu/setApis' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '强制下线','/api/sysOnlineUser/forceLogout','POST','在线用户',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/online-user' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysOnlineUser/forceLogout' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增参数','/api/sysParam/add','POST','系统配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysparam' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysParam/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增角色','/api/sysRole/add','POST','角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysRole/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '添加角色的菜单权限','/api/sysRole/addRoleMenu','POST','角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysRole/addRoleMenu' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '新增用户','/api/users/add','POST','用户管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/account' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/users/add' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '上传个人头像','/api/users/uploadAvatar','POST','个人中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/userinfo' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/users/uploadAvatar' AND method='POST' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改系统配置','/api/config/update','PUT','系统配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysconfig' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/config/update' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改级联平台','/api/gb28181/cascade/platforms/:id','PUT','国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cascade/platforms/:id' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新级联启用状态','/api/gb28181/cascade/platforms/:id/enabled','PUT','国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cascade/platforms/:id/enabled' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新级联共享','/api/gb28181/cascade/platforms/:id/shares','PUT','国标级联',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/cascade' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/cascade/platforms/:id/shares' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '保存仪表盘布局','/api/gb28181/home/layout','PUT','仪表盘',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/home' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/home/layout' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '覆盖播放方案','/api/gb28181/playback-schemes/:id/layout','PUT','多屏播放',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/multi-screen-playback' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/playback-schemes/:id/layout' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '编辑录像计划','/api/gb28181/recording-plans/:id','PUT','录像计划',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/recording-schedules' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/recording-plans/:id' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '启用或停用安全访问规则','/api/gb28181/security/access-rules/:id','PUT','国标接入安全',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/security-preview' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/security/access-rules/:id' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '保存安全防护策略','/api/gb28181/security/policy','PUT','国标接入安全',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/security-preview' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/security/policy' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改全局通道音频配置','/api/gb28181/sip/service-config/default-channel-audio','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/default-channel-audio' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '设置默认码流传输方式','/api/gb28181/sip/service-config/default-channel-stream-transport','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/default-channel-stream-transport' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改默认播放协议','/api/gb28181/sip/service-config/default-playback-protocol','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/default-playback-protocol' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改固定地址播放配置','/api/gb28181/sip/service-config/fixed-address-playback','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/fixed-address-playback' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改全局订阅项目','/api/gb28181/sip/service-config/global-subscriptions','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/global-subscriptions' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改忽略通道离线异常通知配置','/api/gb28181/sip/service-config/ignore-channel-offline-status-notify','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/ignore-channel-offline-status-notify' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改收到心跳恢复设备上线配置','/api/gb28181/sip/service-config/online-on-heartbeat','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/online-on-heartbeat' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改播放鉴权配置','/api/gb28181/sip/service-config/play-auth','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/play-auth' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改回放参数','/api/gb28181/sip/service-config/playback-settings','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/playback-settings' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改移动位置历史轨迹配置','/api/gb28181/sip/service-config/position-history','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/position-history' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改预分配模式','/api/gb28181/sip/service-config/preallocation-mode','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/preallocation-mode' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改云台默认速度配置','/api/gb28181/sip/service-config/ptz-default-speed','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/ptz-default-speed' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改报警消息存储配置','/api/gb28181/sip/service-config/save-alarm-messages','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/save-alarm-messages' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '设置 SDP 扩展参数','/api/gb28181/sip/service-config/sdp-extension','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/sdp-extension' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改 SIP 命令超时时间','/api/gb28181/sip/service-config/sip-command-timeout','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/sip-command-timeout' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改 SIP 日志配置','/api/gb28181/sip/service-config/sip-log','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/sip-log' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改设备上线同步通道配置','/api/gb28181/sip/service-config/sync-channels-on-online','PUT','国标服务配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/service-config/sync-channels-on-online' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '保存 SIP 配置','/api/gb28181/sip/setup/config','PUT','SIP 接入信息',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/gb28181/sip/config' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/sip/setup/config' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新媒体节点','/api/gb28181/zlm/nodes/:id','PUT','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新媒体服务配置','/api/gb28181/zlm/nodes/:id/config','PUT','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/nodes' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/nodes/:id/config' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新媒体调度策略','/api/gb28181/zlm/scheduler','PUT','流媒体管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/media/scheduling' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/zlm/scheduler' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改','/api/plugins/example/edit','PUT','插件示例',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/plugins/example' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/plugins/example/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改文件名','/api/sysAffix/updateName','PUT','文件管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/affix' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysAffix/updateName' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新API','/api/sysApi/edit','PUT','接口管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/api' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysApi/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '编辑部门','/api/sysDepartment/edit','PUT','部门管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/division' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDepartment/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新字典','/api/sysDict/edit','PUT','字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDict/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '编辑字典项','/api/sysDictItem/edit','PUT','字典管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/dictionary' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysDictItem/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '同步数据库','/api/sysGen/refreshFields','PUT','代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysGen/refreshFields' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新代码生成配置和字段信息','/api/sysGen/update','PUT','代码生成',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/codegen' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysGen/update' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '定时任务编辑','/api/sysJobs/edit','PUT','定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysJobs/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '定时任务设置任务状态','/api/sysJobs/setStatus','PUT','定时任务',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysjobslist' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysJobs/setStatus' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新菜单','/api/sysMenu/edit','PUT','菜单管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/menu' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysMenu/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '编辑参数','/api/sysParam/edit','PUT','系统配置',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/sysparam' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysParam/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '设置数据权限','/api/sysRole/dataScope','PUT','角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysRole/dataScope' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新角色','/api/sysRole/edit','PUT','角色管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/role' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/sysRole/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '更新用户信息','/api/users/edit','PUT','用户管理',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/account' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/users/edit' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改密码、手机号等','/api/users/updateAccount','PUT','个人中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/userinfo' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/users/updateAccount' AND method='PUT' AND deleted_at IS NULL);

INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '修改用户基本信息','/api/users/updateBasicInfo','PUT','个人中心',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE ((SELECT id FROM (SELECT MIN(id) AS id FROM sys_menu WHERE path='/system/userinfo' AND type IN (1,2) AND deleted_at IS NULL) AS catalog_parent) IS NOT NULL) AND NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/users/updateBasicInfo' AND method='PUT' AND deleted_at IS NULL);
...
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission='gb28181:play:diagnose' AND m.type=3 AND m.deleted_at IS NULL AND a.path='/api/gb28181/stream-probes/operations/:operationId' AND a.method='GET' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api ma WHERE ma.menu_id=m.id AND ma.api_id=a.id);
...
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission='gb28181:zlm:node:manage' AND m.type=3 AND m.deleted_at IS NULL AND a.path='/api/gb28181/zlm/nodes/:id/disable' AND a.method='POST' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api ma WHERE ma.menu_id=m.id AND ma.api_id=a.id);

INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission='gb28181:zlm:node:manage' AND m.type=3 AND m.deleted_at IS NULL AND a.path='/api/gb28181/zlm/nodes/:id/enable' AND a.method='POST' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api ma WHERE ma.menu_id=m.id AND ma.api_id=a.id);
...
-- 退役国标级联「重连」权限元数据（PostgreSQL 12+，幂等）。
...
-- log-center-menu:start（同步自 migrations/2026-09-17-log-center-menu-postgresql.sql）
...
-- device-config-family:start（同步自 migrations/2026-09-19-device-config-family-postgresql.sql）
...
-- device-config-family-permissions:start（同步自 migrations/2026-09-19-device-config-family-postgresql.sql）
...
-- channel-snapshot-library:start（同步自 migrations/2026-09-20-channel-snapshot-library-postgresql.sql）
...
-- channel-snapshot-library-permissions:start（同步自 migrations/2026-09-20-channel-snapshot-library-postgresql.sql）
...
FROM sys_role_menu rm JOIN sys_menu m ON m.id=rm.menu_id
JOIN sys_menu_api ma ON ma.menu_id=m.id JOIN sys_api a ON a.id=ma.api_id
WHERE m.permission='gb28181:device:snapshot' AND a.path='/api/gb28181/device-mgmt/snapshots/:id/content' AND a.method='GET'
...
-- ---- 图像库列表接口 + 一级菜单（同步自 migrations/2026-09-20-channel-snapshot-library-postgresql.sql） ----
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by)
...
-- storage-card-format-permissions:start（同步自 migrations/2026-09-20-storage-card-format-permission-postgresql.sql）
...
-- realtime-log-menu-rename:start（同步自 migrations/2026-09-21-rename-realtime-log-menu-title-postgresql.sql）
-- 将「实时日志控制台」更名为「运行日志」。
...
UPDATE sys_menu SET title='运行日志',updated_at=CURRENT_TIMESTAMP
WHERE permission='gb28181:log:view' AND deleted_at IS NULL AND title<>'运行日志';
-- realtime-log-menu-rename:end

-- realtime-log-menu-icon:start（同步自 migrations/2026-09-21-realtime-log-menu-icon-postgresql.sql）
...
UPDATE sys_api SET api_group='多屏播放' WHERE path='/api/gb28181/play/lifecycles' AND method='GET' AND api_group<>'多屏播放';
UPDATE sys_api SET api_group='多屏播放' WHERE path='/api/gb28181/play/lifecycles/:lifecycleId' AND method='GET' AND api_group<>'多屏播放';
UPDATE sys_api SET api_group='多屏播放' WHERE path='/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND method='POST' AND api_group<>'多屏播放';
...
CREATE TABLE IF NOT EXISTS gb_play_attempt (
  ...
  stream_id VARCHAR(128) NOT NULL DEFAULT '', ssrc VARCHAR(32) NOT NULL DEFAULT '',
  call_id VARCHAR(128) NOT NULL DEFAULT '', cseq VARCHAR(32) NOT NULL DEFAULT '',
  current_stage VARCHAR(32) NOT NULL DEFAULT 'unknown', media_state VARCHAR(32) NOT NULL DEFAULT 'unknown',
  client_state VARCHAR(32) NOT NULL DEFAULT 'unknown', lifecycle_state VARCHAR(32) NOT NULL DEFAULT 'in_progress',
  reason_code VARCHAR(64) NOT NULL DEFAULT '', reason_message VARCHAR(256) NOT NULL DEFAULT '',
  client_first_frame_at TIMESTAMP(3) NULL, client_error_at TIMESTAMP(3) NULL,
  client_error_code VARCHAR(64) NOT NULL DEFAULT '', last_event_at TIMESTAMP(3) NULL,
...
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询播放日志','/api/gb28181/play/lifecycles','GET','播放日志',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/play/lifecycles' AND method='GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '查询播放日志详情','/api/gb28181/play/lifecycles/:lifecycleId','GET','播放日志',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/play/lifecycles/:lifecycleId' AND method='GET' AND deleted_at IS NULL);
INSERT INTO sys_api(title,path,method,api_group,created_at,updated_at,created_by) SELECT '上报播放客户端事实','/api/gb28181/play/lifecycles/:lifecycleId/client-events','POST','播放日志',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_api WHERE path='/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND method='POST' AND deleted_at IS NULL);
INSERT INTO sys_menu(parent_id,path,name,component,title,hide,disable,sort,type,permission,icon,created_at,updated_at,created_by)
SELECT COALESCE((SELECT MIN(id) FROM sys_menu WHERE path='/media' AND type IN (1,2) AND deleted_at IS NULL),0),'/gb28181/playback-log','gb28181-playback-log','gb28181/playback-log/index','播放日志',0,0,7,2,'gb28181:play-log:view','lucide:FileClock',CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,1 WHERE NOT EXISTS (SELECT 1 FROM sys_menu WHERE path='/gb28181/playback-log' AND deleted_at IS NULL);
INSERT INTO sys_role_menu(role_id,menu_id) SELECT 1,m.id FROM sys_menu m WHERE m.path='/gb28181/playback-log' AND m.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_role_menu x WHERE x.role_id=1 AND x.menu_id=m.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.path='/gb28181/playback-log' AND m.deleted_at IS NULL AND a.path IN ('/api/gb28181/play/lifecycles','/api/gb28181/play/lifecycles/:lifecycleId') AND a.method='GET' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_menu_api(menu_id,api_id) SELECT m.id,a.id FROM sys_menu m CROSS JOIN sys_api a WHERE m.permission='gb28181:play:start' AND m.type=3 AND m.deleted_at IS NULL AND a.path='/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND a.method='POST' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_menu_api x WHERE x.menu_id=m.id AND x.api_id=a.id);
INSERT INTO sys_casbin_rule(ptype,v0,v1,v2,v3,v4,v5) SELECT DISTINCT 'p','role_' || rm.role_id,a.path,a.method,'*','','' FROM sys_role_menu rm JOIN sys_menu m ON m.id=rm.menu_id JOIN sys_menu_api ma ON ma.menu_id=m.id JOIN sys_api a ON a.id=ma.api_id WHERE ((m.path='/gb28181/playback-log' AND a.method='GET') OR (m.permission='gb28181:play:start' AND m.type=3 AND a.method='POST')) AND a.path LIKE '/api/gb28181/play/lifecycles%' AND a.deleted_at IS NULL AND NOT EXISTS (SELECT 1 FROM sys_casbin_rule p WHERE p.ptype='p' AND p.v0='role_' || rm.role_id AND p.v1=a.path AND p.v2=a.method AND p.v3='*');
UPDATE sys_api SET api_group='多屏播放' WHERE path='/api/gb28181/play/lifecycles' AND method='GET' AND api_group<>'多屏播放';
UPDATE sys_api SET api_group='多屏播放' WHERE path='/api/gb28181/play/lifecycles/:lifecycleId' AND method='GET' AND api_group<>'多屏播放';
UPDATE sys_api SET api_group='多屏播放' WHERE path='/api/gb28181/play/lifecycles/:lifecycleId/client-events' AND method='POST' AND api_group<>'多屏播放';
