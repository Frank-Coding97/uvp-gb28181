...
// TransportWriteProps describes the transport connection used for an outbound SIP message.
...
// TransportWriteObserver receives an isolated copy of the final serialized SIP bytes
