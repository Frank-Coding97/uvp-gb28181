...
var schema3WidgetDefaults = map[string]WidgetLayout{
	"sip-rpm":               {ID: "sip-rpm", X: 0, Y: 0, W: 4, H: 3, Visible: true},
	"sip-today":             {ID: "sip-today", X: 4, Y: 0, W: 4, H: 3, Visible: true},
	"play-success-24h":      {ID: "play-success-24h", X: 8, Y: 0, W: 4, H: 3, Visible: true},
	"media-traffic-today":   {ID: "media-traffic-today", X: 12, Y: 0, W: 4, H: 3, Visible: true},
	"media-runtime":         {ID: "media-runtime", X: 16, Y: 0, W: 4, H: 3, Visible: true},
	"media-rate":            {ID: "media-rate", X: 0, Y: 3, W: 12, H: 5, Visible: true},
	"device-online-rate":    {ID: "device-online-rate", X: 12, Y: 3, W: 4, H: 5, Visible: true},
	"channel-online-rate":   {ID: "channel-online-rate", X: 16, Y: 3, W: 4, H: 5, Visible: true},
...
var schema5WidgetDefaults = map[string]WidgetLayout{
	"sip-rpm":               {ID: "sip-rpm", X: 0, Y: 0, W: 4, H: 2, Visible: true},
	"sip-today":             {ID: "sip-today", X: 4, Y: 0, W: 4, H: 2, Visible: true},
	"play-success-24h":      {ID: "play-success-24h", X: 8, Y: 0, W: 4, H: 2, Visible: true},
	"media-traffic-today":   {ID: "media-traffic-today", X: 12, Y: 0, W: 4, H: 2, Visible: true},
	...
	"device-online-rate":    {ID: "device-online-rate", X: 12, Y: 2, W: 4, H: 4, Visible: true},
	"channel-online-rate":   {ID: "channel-online-rate", X: 16, Y: 2, W: 4, H: 4, Visible: true},
	"active-stream-ranking": {ID: "active-stream-ranking", X: 0, Y: 11, W: 14, H: 4, Visible: false},
	"media-node-health":     {ID: "media-node-health", X: 14, Y: 11, W: 6, H: 4, Visible: false},
	"sip-monitor":           {ID: "sip-monitor", X: 0, Y: 6, W: 12, H: 5, Visible: true},
	"platform-info":         {ID: "platform-info", X: 12, Y: 6, W: 8, H: 2, Visible: true},
}

var schema6WidgetDefaults = map[string]WidgetLayout{
	"sip-rpm":               {ID: "sip-rpm", X: 0, Y: 0, W: 4, H: 2, Visible: true},
	"sip-today":             {ID: "sip-today", X: 4, Y: 0, W: 4, H: 2, Visible: true},
	"play-success-24h":      {ID: "play-success-24h", X: 8, Y: 0, W: 4, H: 2, Visible: true},
	"media-traffic-today":   {ID: "media-traffic-today", X: 12, Y: 0, W: 4, H: 2, Visible: true},
	...
	"device-online-rate":    {ID: "device-online-rate", X: 12, Y: 2, W: 4, H: 4, Visible: true},
	"channel-online-rate":   {ID: "channel-online-rate", X: 16, Y: 2, W: 4, H: 4, Visible: true},
	"active-stream-ranking": {ID: "active-stream-ranking", X: 0, Y: 13, W: 14, H: 4, Visible: false},
	"media-node-health":     {ID: "media-node-health", X: 12, Y: 6, W: 8, H: 4, Visible: true},
	"sip-monitor":           {ID: "sip-monitor", X: 0, Y: 6, W: 12, H: 7, Visible: true},
	"platform-info":         {ID: "platform-info", X: 12, Y: 10, W: 8, H: 3, Visible: true},
}
