...
type GbAnomalyRecord struct {
	...
	OwnerDeptID    uint         `gorm:"column:owner_dept_id;index:idx_owner_dept_resolved,priority:1" json:"ownerDeptId"`
	...
	Resolved       bool         `gorm:"column:resolved;default:false;index:idx_owner_dept_resolved,priority:2" json:"resolved"`
	...
	CreatedAt      time.Time    `gorm:"index:idx_owner_dept_resolved,priority:3" json:"createdAt"`
}
