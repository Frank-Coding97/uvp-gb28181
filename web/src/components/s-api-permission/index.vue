<template>
  ...
  >
    <div class="api-permission-container">
      <s-layout-search>
        <template #fields>
          ...
          <a-input
            ...
            @press-enter="handleSearch"
          />
          <a-select v-model="searchForm.method" placeholder="请求方法" allow-clear style="width: 126px">
      ...
      <div class="uvp-dialog-selection">
        <a-checkbox v-model="selectAllCurrent" @change="toggleSelectAll" :indeterminate="indeterminate"> 全选当前页 </a-checkbox>
        <div class="uvp-dialog-selection__actions">
          <span class="uvp-dialog-selection__summary">
            已选择 <a-tag color="arcoblue">{{ selectedApiIds.length }}</a-tag> 个API
          </span>
