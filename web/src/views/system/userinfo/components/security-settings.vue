<template>
  <a-form
    class="uvp-system-form userinfo-form"
    :model="form"
    :rules="rules"
    :style="{ width: layoutMode.width }"
  ...
  >
    ...
    <a-form-item :label-col-flex="isMobile ? '100px' : '80px'" class="userinfo-form__actions">
      <a-button type="primary" html-type="submit" v-hasPerm="['system:userinfo:updateAccount']">提交</a-button>
    </a-form-item>
  </a-form>
</template>
