...
.tree-operation-card :deep(.arco-card-body) {
  padding: 12px 14px;
}

.tree-operation-card :deep(.arco-space) {
  row-gap: 10px;
}

.tree-container :deep(.arco-card-body) {
  max-height: 280px;
  padding: 10px 12px;
  overflow: auto;
}
