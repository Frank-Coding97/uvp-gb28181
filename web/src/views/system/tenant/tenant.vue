    ...
    <a-card class="general-card uvp-system-panel" :bordered="false">
      <s-layout-search>
        <template #fields>
          ...
          <a-input v-model="formModel.code" placeholder="请输入租户编码" style="width: 176px" allow-clear @press-enter="search" />
          <a-select v-model="formModel.status" placeholder="请选择状态" style="width: 126px" allow-clear>
        ...
        <a-col :span="24">
          ...
          >
            <template #columns>
              ...
              <a-table-column title="操作" :width="210" :fixed="isMobile ? '' : 'right'">
                <template #cell="{ record }">
                  <div class="uvp-table-actions">
                    ...
                    <a-popconfirm content="确定要删除该租户吗?" @ok="handleDelete(record)">
                      <a-link class="uvp-table-action uvp-table-action--delete" v-hasPerm="['system:tenant:delete']">
