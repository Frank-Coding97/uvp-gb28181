<template>
  <div class="dashboard-shell">
    ...
    <main v-else ref="gridElement" class="grid-stack dashboard-grid" :class="{ editing }">
      <article v-for="widget in visibleWidgets" :key="widget.id" class="grid-stack-item"
