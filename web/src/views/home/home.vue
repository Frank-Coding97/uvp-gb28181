        ...
        <div class="grid-stack-item-content card">
          ...
          <template v-else-if="widget.id === 'platform-info'">
            ...
            <div class="platform-info">
              ...
              <span class="platform-clock"><small>当前时间</small><em>{{ platformClockDate }}</em><span class="clock-time-shell"><Transition name="clock-tick"><strong :key="platformClockTime" class="clock-time">{{ platformClockTime }}</strong></Transition></span></span>
            </div>
          </template>
