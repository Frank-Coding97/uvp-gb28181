      ...
      <article v-for="widget in visibleWidgets" :key="widget.id" class="grid-stack-item" :class="`widget-${widget.id}`"
        ...
        <div class="grid-stack-item-content card">
          ...
          <template v-else-if="widget.id === 'media-runtime'">
            <header class="runtime-title"><Server :size="20" /><strong>流媒体运行态</strong></header>
...
import { GripHorizontal, LayoutDashboard, LoaderCircle, Pencil, RefreshCw, RotateCcw, Save, Server } from "lucide-vue-next";
