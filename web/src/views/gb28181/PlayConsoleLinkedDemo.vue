...
/**
 * PlayConsoleLinkedDemo - 播放控制台双区联动原型演示页
 *
 * 访问方式: http://localhost:5177/play-console-linked-demo
 * 作用: 与现版并存,独立预览右侧操作区 + 下方详情区的联动布局
 * 数据: 全 mock,不发任何真实请求
 */
import { ref } from "vue";
  ...
  <div class="demo-wrapper">
    ...
    <div class="demo-toolbar">
      <div class="toolbar-title">
        ...
        <strong>播放控制台 · 双区联动版</strong>
        <small>右侧高频操作 · 下方联动详情</small>
      </div>
